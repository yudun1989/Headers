...
@interface WAJSContextPlugin_RemoteDebug : WAJSContextPluginBase
{
    ...
    unsigned int _sendLength;
    unsigned int _sendCount;
    unsigned int _recvLength;
...
@property(nonatomic) unsigned int recvLength; // @synthesize recvLength=_recvLength;
@property(nonatomic) unsigned int sendCount; // @synthesize sendCount=_sendCount;
@property(nonatomic) unsigned int sendLength; // @synthesize sendLength=_sendLength;
