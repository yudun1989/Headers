...
- (void)remoteSetupContextWithConfigureJS:(id)arg1 publibVersion:(unsigned int)arg2 publibMD5:(id)arg3 threeJSMD5:(id)arg4;
...
- (void)beginDebugWithRoomID:(id)arg1 pkgInfo:(id)arg2 channelType:(unsigned int)arg3 proxyPort:(unsigned int)arg4;
