...
#import "WCVMPatchBootsExt-Protocol.h"

@class NSString;

@interface WCVMPatchResourceMgr : MMService <MMResourceMgrExt, WCVMPatchBootsExt, MMService>
{
}
...
- (void)onServiceInit;
- (void)dealloc;
- (void)forceUpdatePatch:(_Bool)arg1;
- (id)getPatchZipFile;
