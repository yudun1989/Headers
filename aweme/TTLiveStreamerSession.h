...
@class NSArray, NSString, NSTimer, TTLivePreviewView, TTLiveStreamerQoSInfo, UIView;
@protocol OS_dispatch_queue, TTLiveStreamerSessionDelegate;

@interface TTLiveStreamerSession : NSObject
{
    TTLivePreviewView *_previewView;
    ...
    long long _m_qos_inputFrames;
}

+ (id)getSdkVersion;
@property long long m_qos_inputFrames; // @synthesize m_qos_inputFrames=_m_qos_inputFrames;
