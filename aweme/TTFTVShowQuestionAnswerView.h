...
@class CAGradientLayer, CAShapeLayer, NSMutableArray, NSString, TTFQuestionAnswerUnit, TTFRebirthCardAnimationView, TTFResultTipsView, TTFTimeUpView, UIImageView, UILabel;
@protocol TTFQAViewDelegate;

@interface TTFTVShowQuestionAnswerView : UIView <TTFQuestionOptionViewDelegate, TTFQAViewProtocol>
{
    _Bool _isTVShowQAViewShow;
    _Bool _isQAViewShow;
...
@property(readonly, nonatomic) _Bool isTVShowQAViewShow; // @synthesize isTVShowQAViewShow=_isTVShowQAViewShow;
