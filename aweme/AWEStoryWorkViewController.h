...
@class AWEStoryUserWorkDataManager, NSString, UICollectionView, UILabel;
@protocol AWEUserWorkViewControllerDelegate;

@interface AWEStoryWorkViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEStoryDataMessage, AWEPreviewable, AWEVideosCollectionViewAnimationDelegate>
{
    _Bool _initialLoadMoreEnabled;
    UICollectionView *_collectionView;
    id <AWEUserWorkViewControllerDelegate> _delegate;
    UILabel *_emptyLabel;
    UILabel *_sectionZeroDateLabel;
    AWEStoryUserWorkDataManager *_dataManager;
}

@property(retain, nonatomic) AWEStoryUserWorkDataManager *dataManager; // @synthesize dataManager=_dataManager;
@property(retain, nonatomic) UILabel *sectionZeroDateLabel; // @synthesize sectionZeroDateLabel=_sectionZeroDateLabel;
