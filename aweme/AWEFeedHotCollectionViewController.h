...
@interface AWEFeedHotCollectionViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEPreviewable, AWEFeedTabItemViewControllerProtocol, AWEFeedViewControllerSwitchProtocol, AWEVideosCollectionViewAnimationDelegate>
{
    _Bool _isAppear;
