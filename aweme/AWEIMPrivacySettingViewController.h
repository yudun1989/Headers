...
@class AWEIMChatDetailNavView, NSMutableArray, NSString, UITableView;

@interface AWEIMPrivacySettingViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, BTDRouterViewControllerProtocol>
{
