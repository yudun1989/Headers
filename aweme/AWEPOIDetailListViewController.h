...
@class AWEPOIDetailAwemeListDataManager, NSString, UICollectionView, UILabel;
@protocol AWEPOIDetailListViewControllerDelegate;

@interface AWEPOIDetailListViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AWEPreviewable, AWEVideosCollectionViewAnimationDelegate>
{
    id <AWEPOIDetailListViewControllerDelegate> _delegate;
    UICollectionView *_collectionView;
    NSString *_poiID;
    unsigned long long _type;
    UILabel *_emptyLabel;
    AWEPOIDetailAwemeListDataManager *_dataManager;
...
@property(retain, nonatomic) AWEPOIDetailAwemeListDataManager *dataManager; // @synthesize dataManager=_dataManager;
...
@property(nonatomic) __weak id <AWEPOIDetailListViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
