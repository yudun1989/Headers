...
@interface AWEUserDetailHeaderView : UIView
{
    ...
    UIImageView *_bindingToutiaoIconImageView;
...
@property(retain, nonatomic) UIImageView *bindingToutiaoIconImageView; // @synthesize bindingToutiaoIconImageView=_bindingToutiaoIconImageView;
...
@property(retain, nonatomic) UIButton *showBindedAppButton; // @synthesize showBindedAppButton=_showBindedAppButton;
...
- (id)_getUserAge;
- (id)_idStr;
- (void)updateBindingAppHomePageButton;
- (void)layoutSubviews;
