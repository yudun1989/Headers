...
@interface AWELiveDebugViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, BTDRouterViewControllerProtocol>
{
...
- (void).cxx_destruct;
- (void)_setupData;
- (void)_makeAllPressureTestOn:(_Bool)arg1;
