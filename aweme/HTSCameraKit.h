...
@class AVCaptureAudioDataOutput, AVCaptureDevice, AVCaptureDeviceInput, AVCaptureMetadataOutput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, HTSAudioCapture, HTSCameraConfiguration, NSMutableArray, NSString;
...
- (void).cxx_destruct;
- (void)resetPreviewLayer:(id)arg1;
