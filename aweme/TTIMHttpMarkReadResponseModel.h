...
@class NSNumber, NSString, TTIMHttpDeliveSilenceModel, TTIMHttpMarkReadModel;
@protocol Optional;

@interface TTIMHttpMarkReadResponseModel : JSONModel
{
    NSNumber *_cmd;
    NSString *_seqId;
    NSNumber<Optional> *_statusCode;
    TTIMHttpDeliveSilenceModel<Optional> *_deliveSilence;
    TTIMHttpMarkReadModel<Optional> *_markReadModel;
}

+ (id)keyMapper;
@property(retain, nonatomic) TTIMHttpMarkReadModel<Optional> *markReadModel; // @synthesize markReadModel=_markReadModel;
