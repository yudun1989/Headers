...
@interface IESAntiSpam : NSObject
{
    ...
    CDUnknownBlockType _IESAntiSpamDeviceIDBlock;
...
@property(copy, nonatomic) CDUnknownBlockType IESAntiSpamDeviceIDBlock; // @synthesize IESAntiSpamDeviceIDBlock=_IESAntiSpamDeviceIDBlock;
- (void).cxx_destruct;
