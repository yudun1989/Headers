...
@class HTSGLFilterNewEffect, HTSGLProgram, IESMMBodydanceFilter, NSMutableArray;
...
@property __weak HTSGLFilterNewEffect *effectFilter; // @synthesize effectFilter=_effectFilter;
@property __weak IESMMBodydanceFilter *bodydanceFilter; // @synthesize bodydanceFilter=_bodydanceFilter;
- (void).cxx_destruct;
- (void)dealloc;
- (void)endProcessing;
