...
@class AWEIMChatDetailNavView, AWEIMNotificationListDataController, NSString, UITableView;

@interface AWEIMAssistantViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, BTDRouterViewControllerProtocol>
{
