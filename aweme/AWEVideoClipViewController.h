...
@class AVAssetExportSession, AVAssetImageGenerator, AVPlayer, AVPlayerLayer, AWEAnimatedButton, AWEButton, HTSVideoSpeedControl, NSArray, NSString, NSTimer, NSURL, NSValue, SAVideoRangeSlider, UIButton, UICollectionView, UINavigationController, UIView;
@protocol UIGestureRecognizerDelegate;

@interface AWEVideoClipViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, SAVideoRangeSliderDelegate, UIScrollViewDelegate, HTSVideoSpeedControlDelegate>
{
