...
#import "TTFIntroductionViewControllerDelegate-Protocol.h"
...
@class NSDictionary, NSString, TTFDashboardViewWrapper, TTFInputInvitationCodeView, TTFIntroductionViewController, TTFQuizShowLiveRoomViewController, TTFQuizShowLiveRoomViewModel, TTFRevivalTaskView, TTFSecondDashBoardView, UIButton, UIImageView;

@interface TTFDashboardViewController : TTFBaseViewController <TTFQuizShowLiveRoomViewControllerProtocol, TTFSecondDashBoardBannerBackgroudDelegate, TTFDashboardViewWrapperDelegate, TTFIntroductionViewControllerDelegate, TTFRevivalTaskDelegate>
{
    ...
    TTFIntroductionViewController *_introductionVC;
...
@property(nonatomic) __weak TTFIntroductionViewController *introductionVC; // @synthesize introductionVC=_introductionVC;
...
- (void)introductionViewControllerDidDismiss:(id)arg1;
...
- (void)ttf_setupViews;
- (void)ttf_removeIntroduction;
- (void)ttf_showIntroduction;
