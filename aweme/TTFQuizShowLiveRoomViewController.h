...
@class LOTAnimationView, NSDate, NSString, NSTimer, TTFClearanceUsersView, TTFCoinAnimationView, TTFCountdownView, TTFInputInvitationCodeView, TTFLiveTracker, TTFPlayer, TTFQuizShowLiveRoomViewModel, TTFRadialGradientLayer, TTFResurrectionTipView, TTFRevivalTaskView, TTFTVShowLogoView, TTFTalkBoardViewController, TTFTeamBattleFormSuccessView, TTVideoEngine, UIActivityIndicatorView, UIButton, UILabel, UISwitch, UITapGestureRecognizer, UIView;
@protocol TTFQAViewProtocol, TTFQuizShowLiveRoomViewControllerProtocol;

@interface TTFQuizShowLiveRoomViewController : TTFBaseViewController <TTFQuizShowLiveRoomQuestionAnswerDelegate, TTFQuizShowLiveRoomDelegate, TTFQAViewDelegate, TTFPlayerDelegate, TTFClearanceUsersViewDelegate, TTFResurrectionDelegate, TTFEliminateDefeatViewDelegate, TTFEliminateViewDelegate, TTFLateViewDelegate, TTVideoEngineDelegate, TTFQuizShowLiveRoomViewModelDebugProtocol, TTFLiveTrackerDataSource, TTFTeamBattleEntranceDelegate, TTFTeamVCDelegate, TTFQRCodeReaderViewControllerDelegate, TTFEliminateBonusViewDelegate, TTFEliminateLotteryViewDelegate, TTFRevivalTaskDelegate>
{
    ...
    TTFTVShowLogoView *_tvShowLogoView;
...
@property(retain, nonatomic) TTFTVShowLogoView *tvShowLogoView; // @synthesize tvShowLogoView=_tvShowLogoView;
...
- (void)didSelectCreateTeamWithTrackData:(id)arg1;
