...
@protocol AWELiveSimplePingDelegate;

@interface AWELiveSimplePing : NSObject
{
    _Bool _nextSequenceNumberHasWrapped;
    unsigned short _identifier;
    unsigned short _nextSequenceNumber;
    NSString *_hostName;
    id <AWELiveSimplePingDelegate> _delegate;
...
@property(nonatomic) __weak id <AWELiveSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
