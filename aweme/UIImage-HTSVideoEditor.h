...
- (void)previewImageUsingFilterEffect:(unsigned long long)arg1 filterPath:(id)arg2 filterType:(unsigned long long)arg3 compeletion:(CDUnknownBlockType)arg4 frameTime:(CDStruct_1b6d18a9)arg5;
