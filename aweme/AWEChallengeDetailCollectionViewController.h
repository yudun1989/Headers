...
{
    id <AWEChallengeDetailCollectionViewScrollDelegate> _scrollDelegate;
...
@property(nonatomic) __weak id <AWEChallengeDetailCollectionViewScrollDelegate> scrollDelegate; // @synthesize scrollDelegate=_scrollDelegate;
- (void).cxx_destruct;
