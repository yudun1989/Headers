...
#import "MBKBikeItemViewCellDelegate-Protocol.h"
...
@interface MBKSelectBikeViewController : MBKBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, MMMapContextDelegate, MBKBikeItemViewCellDelegate, MBKDataProviderDelegate>
{
