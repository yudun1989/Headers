...
@class GtAsyncReadPacket, GtAsyncSocketPreBuffer, GtAsyncWritePacket, NSData, NSMutableArray;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface GtAsyncSocket : NSObject
{
    unsigned int flags;
...
+ (unsigned short)gt_portFromSockaddr6:(const struct sockaddr_in6 *)arg1;
+ (unsigned short)gt_portFromSockaddr4:(const struct sockaddr_in *)arg1;
+ (id)gt_hostFromSockaddr6:(const struct sockaddr_in6 *)arg1;
+ (id)gt_hostFromSockaddr4:(const struct sockaddr_in *)arg1;
+ (void)gt_unscheduleCFStreams:(id)arg1;
+ (void)gt_scheduleCFStreams:(id)arg1;
+ (void)gt_cfstreamThread;
+ (void)gt_startcfstreamThreadIfNeeded;
- (void).cxx_destruct;
- (struct SSLContext *)sslContext;
