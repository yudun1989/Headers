...
@interface GtkDatabase : NSObject
{
    void *_db;
...
+ (id)gtk_storeableDateFormat:(id)arg1;
+ (_Bool)gtk_isSQLiteThreadSafe;
+ (id)gtk_SqliteLibVersion;
+ (int)GtkDBVersion;
+ (id)GtkDBUserVersion;
+ (id)gtk_databaseWithPath:(id)arg1;
...
- (_Bool)gtk_executeUpdate:(id)arg1 withErrorAndBindings:(id *)arg2;
...
- (_Bool)close;
- (_Bool)gtk_openWithFlags:(int)arg1 vfs:(id)arg2;
- (_Bool)gtk_openWithFlags:(int)arg1;
- (_Bool)open;
