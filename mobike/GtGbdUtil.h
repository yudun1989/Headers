...
@interface GtGbdUtil : NSObject
{
    id gxModuleContent_;
}

+ (id)md5String:(id)arg1;
+ (id)buildPostDict:(id)arg1 type:(id)arg2 cid:(id)arg3;
+ (id)genAppPlugins;
+ (id)readMyHWI;
+ (void)saveMyHWI:(id)arg1;
...
+ (id)decryptionValue:(id)arg1 extraKey:(id)arg2;
+ (id)encryptValue:(id)arg1 extraKey:(id)arg2;
