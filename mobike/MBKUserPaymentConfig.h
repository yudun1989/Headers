...
@interface MBKUserPaymentConfig : NSObject
{
    _Bool _isMonthCardValidInLocationCountry;
...
@property(readonly, nonatomic) _Bool isMonthCardValidInLocationCountry; // @synthesize isMonthCardValidInLocationCountry=_isMonthCardValidInLocationCountry;
