...
@interface MBKDidaTipsModel : NSObject <MBKViewModelProtocol>
{
    _Bool _willCellBeHidden;
    NSString *_tipsStr;
    NSString *_tipMoneyStr;
}

@property(nonatomic) _Bool willCellBeHidden; // @synthesize willCellBeHidden=_willCellBeHidden;
@property(copy, nonatomic) NSString *tipMoneyStr; // @synthesize tipMoneyStr=_tipMoneyStr;
