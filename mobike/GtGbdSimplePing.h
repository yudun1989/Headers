...
@protocol GtGbdSimplePingDelegate;

@interface GtGbdSimplePing : NSObject
{
    ...
    double _spendTime;
    NSString *_hostName;
    id <GtGbdSimplePingDelegate> _delegate;
...
@property(nonatomic) __weak id <GtGbdSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
