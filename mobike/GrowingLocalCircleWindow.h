...
@class GROMagnifierView, GrowingHelperMenu, GrowingTaggedViews, NSArray, NSMapTable, NSMutableArray, NSString, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
