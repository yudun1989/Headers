...
{
    float _horizontalEdgeLength;
    float _verticalEdgeLength;
    float _margin;
    float _lineWidth;
...
@property(nonatomic) float verticalEdgeLength; // @synthesize verticalEdgeLength=_verticalEdgeLength;
@property(nonatomic) float horizontalEdgeLength; // @synthesize horizontalEdgeLength=_horizontalEdgeLength;
- (void).cxx_destruct;
