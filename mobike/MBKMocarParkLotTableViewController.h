...
@class MBKLBSManager, NSArray, NSString, UITableView;

@interface MBKMocarParkLotTableViewController : MBKBaseViewController <UITableViewDelegate, UITableViewDataSource>
{
