...
@class CLLocationManager, MAAngleIndicator, MAAnimationTaskManager, MAAnnotationContainerView, MACircle, MACompassView, MAENInlandMapTileOverlay, MAIndoorInfo, MAIndoorView, MAMapRender, MAOverlayContainerView, MAScaleViewLite, MATapPanToZoomGestureRecognizer, MAUserLocation, MAUserLocationRepresentation, MAViewRecycler, MAWorldMapTileOverlay, MapStatus, NSData, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, UIColor, UIImageView, UILabel, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@property(nonatomic) NSNumber *mapLanguage; // @synthesize mapLanguage=_mapLanguage;
