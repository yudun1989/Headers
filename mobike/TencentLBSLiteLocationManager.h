...
@class CLLocation, CLLocationManager, NSMutableArray, NSString, TencentLBSLiteLocation, TencentLBSLiteLocationReGeocoder, TencentLBSLiteTrace;
@protocol OS_dispatch_source, TencentLBSLiteLocationManagerDelegate;
...
@interface TencentLBSLiteLocationManager : NSObject <CLLocationManagerDelegate>
{
    ...
    TencentLBSLiteLocation *_beaconLocation;
...
@property(retain, nonatomic) TencentLBSLiteLocation *beaconLocation; // @synthesize beaconLocation=_beaconLocation;
