...
@interface customerServiceNegativeComplaintViewController : MBKBaseViewController <UITextViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIAlertViewDelegate>
{
    UIButton *report;
    UIButton *makePhoto;
