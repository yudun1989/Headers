...
@class GtkDatabase, GtkStatement, NSArray, NSMutableDictionary, NSString;

@interface GtkResultSet : NSObject
{
    GtkDatabase *_parentDB;
    GtkStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)gtk_resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) GtkStatement *statement; // @synthesize statement=_statement;
