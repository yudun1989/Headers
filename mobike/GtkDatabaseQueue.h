...
@class GtkDatabase, NSString;
@protocol OS_dispatch_queue;

@interface GtkDatabaseQueue : NSObject
{
    NSString *_path;
...
+ (Class)gtk_databaseClass;
+ (id)gtk_databaseQueueWithPath:(id)arg1 flags:(int)arg2;
+ (id)gtk_databaseQueueWithPath:(id)arg1;
