...
@interface MBKRidingRouteModel : NSObject <MBKViewModelProtocol>
{
    _Bool _willCellBeHidden;
    NSString *_timeStr;
    NSString *_mileageStr;
}

@property(nonatomic) _Bool willCellBeHidden; // @synthesize willCellBeHidden=_willCellBeHidden;
@property(copy, nonatomic) NSString *mileageStr; // @synthesize mileageStr=_mileageStr;
