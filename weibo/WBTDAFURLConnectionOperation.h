...
@interface WBTDAFURLConnectionOperation : NSOperation <NSCoding, NSCopying>
{
    _Bool _cancelled;
    short _state;
    ...
    double responseFinishTime;
}

+ (id)networkRequestThread;
+ (void)networkRequestThreadEntryPoint:(id)arg1;
@property(nonatomic) double responseFinishTime; // @synthesize responseFinishTime;
@property(nonatomic) double responseReceiveTime; // @synthesize responseReceiveTime;
