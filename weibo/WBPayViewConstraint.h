...
#import "WBPayConstraint.h"

#import "NSCopying-Protocol.h"

@class UIView, WBPayLayoutConstraint, WBPayViewAttribute;

@interface WBPayViewConstraint : WBPayConstraint <NSCopying>
{
    _Bool _hasLayoutRelation;
    _Bool _useAnimator;
    float _layoutPriority;
    WBPayViewAttribute *_firstViewAttribute;
    WBPayViewAttribute *_secondViewAttribute;
    UIView *_installedView;
    WBPayLayoutConstraint *_layoutConstraint;
...
@property(nonatomic) __weak WBPayLayoutConstraint *layoutConstraint; // @synthesize layoutConstraint=_layoutConstraint;
@property(nonatomic) __weak UIView *installedView; // @synthesize installedView=_installedView;
@property(retain, nonatomic) WBPayViewAttribute *secondViewAttribute; // @synthesize secondViewAttribute=_secondViewAttribute;
@property(readonly, nonatomic) WBPayViewAttribute *firstViewAttribute; // @synthesize firstViewAttribute=_firstViewAttribute;
- (void).cxx_destruct;
- (void)uninstall;
