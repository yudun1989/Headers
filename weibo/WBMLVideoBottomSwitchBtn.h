...
@protocol WBMLVideoBottomSwitchBtnDelegate;

@interface WBMLVideoBottomSwitchBtn : UIView <UIGestureRecognizerDelegate>
{
    _Bool _isOn;
    id <WBMLVideoBottomSwitchBtnDelegate> _delegate;
...
@property(nonatomic) __weak id <WBMLVideoBottomSwitchBtnDelegate> delegate; // @synthesize delegate=_delegate;
