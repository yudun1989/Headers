...
@protocol WBTDASICacheDelegate, WBTDASIHTTPRequestDelegate, WBTDASIHTTPRequestDelegate><WBTDASIProgressDelegate, WBTDASIProgressDelegate;

@interface WBTDASIHTTPRequest : NSOperation <NSCopying>
{
    NSURL *url;
    NSURL *originalURL;
    NSURL *redirectURL;
    id <WBTDASIHTTPRequestDelegate> delegate;
    id <WBTDASIHTTPRequestDelegate><WBTDASIProgressDelegate> queue;
    ...
    id <WBTDASIProgressDelegate> uploadProgressDelegate;
    id <WBTDASIProgressDelegate> downloadProgressDelegate;
    ...
    WBTDASIHTTPRequest *mainRequest;
    ...
    NSTimer *statusTimer;
    id <WBTDASICacheDelegate> downloadCache;
    int cachePolicy;
    ...
    WBTDASIHTTPRequest *PACFileRequest;
...
+ (void)initialize;
@property _Bool cancelAutoRetry; // @synthesize cancelAutoRetry=_cancelAutoRetry;
...
@property(retain, nonatomic) WBTDASIHTTPRequest *PACFileRequest; // @synthesize PACFileRequest;
...
@property id <WBTDASICacheDelegate> downloadCache; // @synthesize downloadCache;
...
@property WBTDASIHTTPRequest *mainRequest; // @synthesize mainRequest;
