...
@class NSMutableData, NSProgress, NSString, NSURL, WBPSManager;

@interface WBPUSMTDelegate : WBPDMObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    WBPSManager *_manager;
...
@property(nonatomic) __weak WBPSManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
