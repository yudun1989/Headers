...
@class CALayer, CAShapeLayer, NSMutableArray, NSObject, WBPhotoEditorMosaicLayerParame;
...
@interface WBPhotoEditorMosaicPaintView : UIImageView
{
    ...
    WBPhotoEditorMosaicLayerParame *_currentBackLayerParame;
...
@property(retain, nonatomic) WBPhotoEditorMosaicLayerParame *currentBackLayerParame; // @synthesize currentBackLayerParame=_currentBackLayerParame;
