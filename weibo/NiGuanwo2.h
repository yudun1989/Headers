...
@class CALayer, NSTimer, NiGuanwo1, UIColor, UIControl, UIFont, UIImage, UIImageView, UILabel;

@interface NiGuanwo2 : UIView
{
...
@property(retain, nonatomic) NiGuanwo1 *backgroundRingView; // @synthesize backgroundRingView=_backgroundRingView;
@property(retain, nonatomic) NiGuanwo1 *ringView; // @synthesize ringView=_ringView;
