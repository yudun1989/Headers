...
@protocol WBMusicListCellDelegate;

@interface WBMusicListCell : UITableViewCell
{
    _Bool _hideSeparateLine;
    id <WBMusicListCellDelegate> _delegate;
...
@property(nonatomic) __weak id <WBMusicListCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)tapAddButton;
- (void)playMusic;
