...
@interface InfiniteScrollingView : UIView
{
    ...
    InfiniteScrollingView *_yxt_infiniteScrollingView;
}

@property(retain, nonatomic, setter=yxt_setInfiniteScrollingView:) InfiniteScrollingView *yxt_infiniteScrollingView; // @synthesize yxt_infiniteScrollingView=_yxt_infiniteScrollingView;
