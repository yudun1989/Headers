...
@protocol WBNLFloatStatusViewDelegate;

@interface WBNLFloatStatusView : UIControl
{
    ...
    long long _playTime;
    id <WBNLFloatStatusViewDelegate> _delegate;
...
@property(retain, nonatomic) UIImageView *paidIV; // @synthesize paidIV=_paidIV;
...
@property(nonatomic) __weak id <WBNLFloatStatusViewDelegate> delegate; // @synthesize delegate=_delegate;
