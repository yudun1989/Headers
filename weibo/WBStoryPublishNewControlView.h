...
@class NSDictionary, NSString, UIButton, WBStoryControlViewButton, WBStoryKeyboardObserver, WBStoryMusicItem, WBStoryPublishTextView, WBStorySendButton, WBStorySettings;
@protocol WBStoryPublishPanelDelegate;

@interface WBStoryPublishNewControlView : UIView <WBStoryKeyboardObserverDelegate, WBStoryPublishTextViewDelegate, WBStoryPublishPanel>
{
