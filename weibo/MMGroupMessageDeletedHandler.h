...
@class MMGroupInfo, MMRecallMessageInfo;

@interface MMGroupMessageDeletedHandler : MMEventHandler
{
...
@property(retain, nonatomic) MMGroupInfo *groupInfo; // @synthesize groupInfo=_groupInfo;
- (void).cxx_destruct;
