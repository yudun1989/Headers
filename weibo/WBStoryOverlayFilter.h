...
@interface WBStoryOverlayFilter : GPUImageFilter
{
...
- (void)GpuImageFilter_NewFrameReadyAtTime:(CDStruct_1b6d18a9)arg1 atIndex:(long long)arg2;
...
- (id)initWithMix:(double)arg1 andPosVertices:(float *)arg2;
