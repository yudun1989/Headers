...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, WBPHBP;
@protocol NSStreamDelegate;

@interface WBPMBS : NSInputStream <NSCopying, NSStreamDelegate>
{
...
@property(retain, nonatomic) WBPHBP *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
...
- (void)aHBP:(id)arg1;
- (void)sIAFB;
- (id)initWithSE:(unsigned long long)arg1;
