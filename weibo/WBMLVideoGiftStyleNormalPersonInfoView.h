...
@class UIButton, UILabel, WBMLVideoGiftWithSenderModel, WBMLVideoLiveUserView;

@interface WBMLVideoGiftStyleNormalPersonInfoView : UIView
{
    WBMLVideoGiftWithSenderModel *_giftData;
    CDUnknownBlockType _headTappedBlock;
    UIView *_bgView;
    UIView *_headView;
    WBMLVideoLiveUserView *_userView;
    UILabel *_nickLabel;
    UILabel *_descLabel;
    UIButton *_tapButton;
}
...
@property(retain, nonatomic) WBMLVideoLiveUserView *userView; // @synthesize userView=_userView;
...
@property(retain, nonatomic) WBMLVideoGiftWithSenderModel *giftData; // @synthesize giftData=_giftData;
- (void).cxx_destruct;
