...
@interface WBGPUImageStickerFilter : WBGPUImageBaseFilter
{
    struct WBGPUImageTwoInputFilter *_stickerFilter;
    unsigned int _stickerTexture;
}

@property(nonatomic) unsigned int stickerTexture; // @synthesize stickerTexture=_stickerTexture;
