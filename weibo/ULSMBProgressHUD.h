...
@class CADisplayLink, NSArray, NSDate, NSProgress, NSString, NSTimer, UIButton, UIColor, UIFont, UILabel, ULSMBBackgroundView;
@protocol ULSMBProgressHUDDelegate;

@interface ULSMBProgressHUD : UIView
{
    ...
    float _progress;
    id <ULSMBProgressHUDDelegate> _delegate;
    ...
    ULSMBBackgroundView *_bezelView;
    ULSMBBackgroundView *_backgroundView;
    UIView *_customView;
    UILabel *_label;
...
@property(readonly, nonatomic) ULSMBBackgroundView *backgroundView; // @synthesize backgroundView=_backgroundView;
@property(readonly, nonatomic) ULSMBBackgroundView *bezelView; // @synthesize bezelView=_bezelView;
...
@property(nonatomic) __weak id <ULSMBProgressHUDDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
