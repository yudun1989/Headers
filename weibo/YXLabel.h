...
#import "YXTextAsyncLayerDelegate-Protocol.h"
#import "YXTextDebugTarget-Protocol.h"

@class NSArray, NSAttributedString, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, UIBezierPath, UIColor, UIFont, YXTextContainer, YXTextDebugOption, YXTextHighlight, YXTextLayout;
@protocol YXTextLinePositionModifier, YXTextParser;

@interface YXLabel : UIView <YXTextDebugTarget, YXTextAsyncLayerDelegate, NSCoding>
{
    NSMutableAttributedString *_innerText;
    YXTextLayout *_innerLayout;
    YXTextContainer *_innerContainer;
    NSMutableArray *_attachmentViews;
    NSMutableArray *_attachmentLayers;
    struct _NSRange _highlightRange;
    YXTextHighlight *_highlight;
    YXTextLayout *_highlightLayout;
    YXTextLayout *_shrinkInnerLayout;
    YXTextLayout *_shrinkHighlightLayout;
...
@property(copy, nonatomic) YXTextDebugOption *debugOption; // @synthesize debugOption=_debugOption;
@property(copy, nonatomic) id <YXTextLinePositionModifier> linePositionModifier; // @synthesize linePositionModifier=_linePositionModifier;
...
@property(retain, nonatomic) id <YXTextParser> textParser; // @synthesize textParser=_textParser;
...
@property(retain, nonatomic) YXTextLayout *textLayout;
