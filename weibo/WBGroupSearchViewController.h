...
@class NSMutableArray, NSString, WBContactEngine, WBContactGroup, WBDirectionalGroup, WBSearchBar;
...
- (void)removeChatCellWithContact:(id)arg1;
- (void)removeChatContact:(id)arg1;
