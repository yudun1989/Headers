...
@protocol WBNLBarrageSwitchBtnDelegate;

@interface WBNLBarrageSwitchBtn : UIView <UIGestureRecognizerDelegate>
{
    _Bool _isOn;
    _Bool _enabled;
    id <WBNLBarrageSwitchBtnDelegate> _delegate;
...
@property(nonatomic) __weak id <WBNLBarrageSwitchBtnDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) _Bool enabled; // @synthesize enabled=_enabled;
@property(nonatomic) _Bool isOn; // @synthesize isOn=_isOn;
- (void).cxx_destruct;
- (void)tapped:(id)arg1;
- (void)layoutSubviews;
- (void)setBulletState:(_Bool)arg1;
- (void)storedState;
