...
@class YXTextPosition;

@interface YXTextRange : UITextRange <NSCopying>
{
    YXTextPosition *_start;
    YXTextPosition *_end;
}
...
@property(readonly, nonatomic) YXTextPosition *end;
@property(readonly, nonatomic) YXTextPosition *start;
- (id)init;
