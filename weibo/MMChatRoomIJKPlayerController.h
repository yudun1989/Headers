...
@class IJKFFMoviePlayerController, NSString, NSTimer, NSURL, UIView, WBLiveLoggerManager, WBLivePlaybackEventAnnouncer, WBVideoPlayInfo;
@protocol WBLivePlaybackEventListener;

@interface MMChatRoomIJKPlayerController : NSObject <MMChatRoomVideoPlayback>
{
