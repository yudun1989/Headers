...
@class AliDetailModel, AliDetailRequest, AliDetailSkuControl, NSDictionary, NSLock, NSString;
...
@property(retain, nonatomic) NSString *styleParamsStr; // @synthesize styleParamsStr=_styleParamsStr;
