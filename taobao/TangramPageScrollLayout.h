...
@class NSArray, NSObject, NSString, NSTimer, TMMuiProgressBar, TMPageControl, TangramBus, UIImageView, UIScrollView;
@protocol TangramItemModelProtocol, TangramPageScrollLayoutDelegate;
