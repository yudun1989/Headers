...
@protocol XSearchDelegateWaterfallLayout;

@interface XSearchWaterfallLayout : UICollectionViewLayout
{
    ...
    id <XSearchDelegateWaterfallLayout> _delegate;
...
@property(nonatomic) __weak id <XSearchDelegateWaterfallLayout> delegate; // @synthesize delegate=_delegate;
