...
@property(retain, nonatomic) UIView *animateModelGuideView; // @synthesize animateModelGuideView=_animateModelGuideView;
...
- (void)removeAnimationModelGuideView;
- (void)trackModelCenter;
- (void)showAnimateModelGuideViewIfNeed;
