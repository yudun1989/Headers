...
@class AliLuaView, AliUnionViewController, LVBlock, NSDictionary, NSMutableArray, NSString, NSURL, UIView;
...
- (void).cxx_destruct;
- (void)startExpoTrack;
- (void)refreshViewExposure:(id)arg1:(id)arg2;
- (void)refreshBlockExposure:(id)arg1;
- (void)refreshPageExposure;
- (void)setExposureView:(id)arg1:(id)arg2:(id)arg3:(id)arg4;
...
- (void)popTopViewController:(id)arg1;
...
- (id)getUserInfo;
- (id)utdid;
- (id)compressPicture:(id)arg1:(int)arg2:(int)arg3:(int)arg4:(int)arg5:(int)arg6;
- (void)uploadFile:(id)arg1:(id)arg2:(id)arg3;
