...
@interface TBHomeAnimationEntranceProvider : NSObject <TBEnvasViewProvider>
{
    NSMutableArray *_entranceViews;
}

@property(retain, nonatomic) NSMutableArray *entranceViews; // @synthesize entranceViews=_entranceViews;
- (void).cxx_destruct;
