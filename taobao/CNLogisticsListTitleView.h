...
@class CNLogisticsListTitleModel, NSLayoutConstraint, UILabel, UIView;

@interface CNLogisticsListTitleView : CNLogisticsDetailCell
{
...
@property(retain, nonatomic) CNLogisticsListTitleModel *cellModel; // @dynamic cellModel;
