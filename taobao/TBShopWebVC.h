...
@interface TBShopWebVC : TBWebViewController <UIGestureRecognizerDelegate, TBShopViewController>
{
    ...
    CDUnknownBlockType _shopWebViewTouchHanlder;
}

@property(copy, nonatomic) CDUnknownBlockType shopWebViewTouchHanlder; // @synthesize shopWebViewTouchHanlder=_shopWebViewTouchHanlder;
