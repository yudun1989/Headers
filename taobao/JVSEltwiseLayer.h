...
@interface JVSEltwiseLayer : NSObject <JVSForwardLayer>
{
    NSUUID *_uuid;
    ...
    struct MetalEltwiseParameter _eltwiseParameter;
...
+ (void)invoke:(float *)arg1 output:(float *)arg2 eltwise:(struct MetalEltwiseParameter *)arg3;
