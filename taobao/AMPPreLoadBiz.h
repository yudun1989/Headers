...
- (void)getTemplateFromCDN:(id)arg1 downloadCallback:(CDUnknownBlockType)arg2;
- (id)getWeexCardTempleteWithTplUrl:(id)arg1 downloadCallback:(CDUnknownBlockType)arg2;
- (id)getWeexCardTempleteWithTplUrlNoCache:(id)arg1 downloadCallback:(CDUnknownBlockType)arg2;
...
- (void)imageMessageUpdateForImageSize:(id)arg1 andData:(id)arg2;
- (void)fetchImageFile:(id)arg1 priority:(long long)arg2 plan:(long long)arg3;
- (id)getMaskImageFile:(id)arg1 haveBig:(_Bool *)arg2;
- (id)getMaskImageFile:(id)arg1 sessionId:(id)arg2 haveBig:(_Bool *)arg3;
- (id)getOrigImageFile:(id)arg1 haveBig:(_Bool *)arg2;
- (id)getOrigImageFile:(id)arg1 sessionId:(id)arg2 haveBig:(_Bool *)arg3;
