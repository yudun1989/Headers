...
@class AMPMessageContext, NSData, NSDate, NSString;
...
@property(copy, nonatomic) NSString *messageInBoxType; // @synthesize messageInBoxType=_messageInBoxType;
