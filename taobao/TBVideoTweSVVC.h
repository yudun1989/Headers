...
@interface TBVideoTweSVVC : TBLiveBaseViewController <UIScrollViewDelegate, UITextFieldDelegate, UIGestureRecognizerDelegate, TBVideoSVRightAreaViewDelegate, TBVideoTweSVViewInterface>
{
    ...
    _Bool _muted;
    long long _videoId;
    TBVideoShortVideoModel *_shortVideoModel;
    TBVideoTweSVInteractor *_tweGVInteractor;
    ...
    TBVideoUIButtonWithBlock *_closeBtn;
    TBVideoSVTopBTNView *_topBTNView;
    CALayer *_btmPortraitMaskLayer;
    CALayer *_btmLandscapeMaskLayer;
    TBVideoSVIntroduceView *_introduceView;
    TBVideoSVPlayerControllView *_playerControllView;
    TBVideoSVGoodsItemView *_goodsItemView;
    TBVideoSVRightAreaView *_rightAreaView;
...
@property(retain, nonatomic) TBVideoSVRightAreaView *rightAreaView; // @synthesize rightAreaView=_rightAreaView;
@property(retain, nonatomic) TBVideoSVGoodsItemView *goodsItemView; // @synthesize goodsItemView=_goodsItemView;
@property(retain, nonatomic) TBVideoSVPlayerControllView *playerControllView; // @synthesize playerControllView=_playerControllView;
@property(retain, nonatomic) TBVideoSVIntroduceView *introduceView; // @synthesize introduceView=_introduceView;
...
@property(retain, nonatomic) TBVideoSVTopBTNView *topBTNView; // @synthesize topBTNView=_topBTNView;
@property(retain, nonatomic) TBVideoUIButtonWithBlock *closeBtn; // @synthesize closeBtn=_closeBtn;
...
@property(retain, nonatomic) TBVideoSVBarrageUtil *barrageMgr; // @synthesize barrageMgr=_barrageMgr;
@property(retain, nonatomic) TBVideoSVCommentInputView *commentInputView; // @synthesize commentInputView=_commentInputView;
...
@property(retain, nonatomic) TBVideoTweSVInteractor *tweGVInteractor; // @synthesize tweGVInteractor=_tweGVInteractor;
@property(retain, nonatomic) TBVideoShortVideoModel *shortVideoModel; // @synthesize shortVideoModel=_shortVideoModel;
