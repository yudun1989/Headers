...
@interface TBScanViewController : UIViewController <TBScanSliderDelegate, UIImagePickerControllerDelegate, UIPopoverControllerDelegate, UINavigationControllerDelegate, UIAlertViewDelegate>
{
    ...
    NSMutableDictionary *_customPluginDict;
...
@property(retain, nonatomic) NSMutableDictionary *customPluginDict; // @synthesize customPluginDict=_customPluginDict;
...
- (void)_scanPhotoLibrary:(struct CGRect)arg1 inView:(id)arg2 permittedArrowDirections:(unsigned long long)arg3 with:(id)arg4;
...
- (void)unregisterPluginWithType:(int)arg1;
