...
@interface JVSSumLayer : NSObject <JVSForwardLayer>
{
    NSUUID *_uuid;
    JVSTensor *_inputTensor;
    NSString *_name;
    JVSInvocation *_forwardInvocation;
    struct MetalSumParameter _forwardSumParameter;
    unsigned char _typeid;
    int _reductionIndices;
...
@property(nonatomic) int reductionIndices; // @synthesize reductionIndices=_reductionIndices;
