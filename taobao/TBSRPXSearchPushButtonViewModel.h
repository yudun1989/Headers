...
@class TBSRPXSearchService, TBSearchPushButtonModel;
@protocol XSearchViewComponent;

@interface TBSRPXSearchPushButtonViewModel : XSearchViewModel
{
    _Bool _isShowing;
...
@property(nonatomic) __weak id <XSearchViewComponent> uiComponent; // @dynamic uiComponent;
