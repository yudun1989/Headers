...
+ (double)heightForInnerContent:(id)arg1 numberOfLines:(long long)arg2 systemFontOfSize:(double)arg3;
+ (double)heightForTitleContent:(id)arg1 numberOfLines:(long long)arg2 systemFontOfSize:(double)arg3;
