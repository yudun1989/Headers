...
@class NSMutableArray, TBFavService, TBFavoriteGoodModel, TBFavoriteGoodRequestModel, TBFavoriteGoodSearchView, TBFavoriteNewGoodMoreView, TBFavoriteNewGoodRequestModel, TBFavoriteNewGoodsTableView, TBFavoriteNewItemListModel, TBFavoriteNewItemModel, TBSheetController;
...
@property(nonatomic) __weak id <TBFavoriteGoodsSearchViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
