...
@class AliDetailBottomBarComponent, AliDetailContractPhoneMainView, AliDetailHintBanner, AliDetailPresalesSVIPBanner, AliTradeCombinationItemsMainViewController, AliTradeSKUView, TBDetailNavigationBar, TBMoreCustomItem, TBTradeDetailViewController, UIActivityIndicatorView, UIImageView, UIView;
...
@interface TBTradeDetailViewBuilder : NSObject
{
    ...
    AliDetailPresalesSVIPBanner *_svipBanner;
...
@property(retain, nonatomic) AliDetailPresalesSVIPBanner *svipBanner; // @synthesize svipBanner=_svipBanner;
