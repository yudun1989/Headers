...
+ (void)saveMessageImage:(id)arg1 sessionId:(id)arg2 image:(id)arg3;
...
+ (struct CGSize)scaleSizeForImage:(id)arg1 width:(float)arg2 hight:(float)arg3;
+ (struct CGSize)scaleSizeFromRealSize:(struct CGSize)arg1;
