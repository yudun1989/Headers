...
@protocol DIVAFileDownloadConnectionDelegate;
...
@interface DIVAFileDownloadConnection : NSObject
{
    ...
    long long _storedContentLength;
}

+ (id)connectionWithURL:(id)arg1 filePath:(id)arg2 target:(id)arg3;
@property(nonatomic) long long storedContentLength; // @synthesize storedContentLength=_storedContentLength;
