...
@interface CNStationCourierInfo : TBJSONModel
{
    int _unReadMsgNum;
    int _imType;
    int _isOpenIm;
...
@property(copy, nonatomic) NSString *courierMobile; // @synthesize courierMobile=_courierMobile;
