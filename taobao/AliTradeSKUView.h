...
+ (id)skuStyleModel;
@property(nonatomic) _Bool screenPortrait; // @synthesize screenPortrait=_screenPortrait;
...
@property(copy, nonatomic) NSDictionary *reverseTradeParams; // @synthesize reverseTradeParams=_reverseTradeParams;
@property(copy, nonatomic) NSString *status; // @synthesize status=_status;
@property(copy, nonatomic) NSString *closeSkuFrom; // @synthesize closeSkuFrom=_closeSkuFrom;
...
@property(retain, nonatomic) id targetVc; // @synthesize targetVc=_targetVc;
@property(retain, nonatomic) AliDetailDataEngine *dataEngine; // @synthesize dataEngine=_dataEngine;
@property(copy, nonatomic) NSString *eventTokenNew; // @synthesize eventTokenNew=_eventTokenNew;
...
- (void)showNumberCardView:(id)arg1 vc:(id)arg2;
- (void)showContractPhoneView:(id)arg1;
...
- (void)componentsClickedToSubPage:(id)arg1;
