...
@property(nonatomic) _Bool useYunOsBeauty; // @synthesize useYunOsBeauty=_useYunOsBeauty;
@property(nonatomic) _Bool useRTP; // @synthesize useRTP=_useRTP;
