...
@interface JVSTransposeLayer : NSObject <JVSForwardLayer>
{
    ...
    struct MetalConcatParameter _concatParameter;
...
@property(nonatomic) int concatAxis; // @synthesize concatAxis=_concatAxis;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)invoke:(void *)arg1 output:(void *)arg2 transpose:(struct MetalTransposeDimensions *)arg3;
...
- (id)initWithAllocator:(struct Allocator *)arg1 type:(unsigned char)arg2 size:(int)arg3 name:(id)arg4 forwardMode:(unsigned long long)arg5;
