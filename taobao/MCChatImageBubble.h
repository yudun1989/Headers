...
@class MCChatBubbleBackgroundView, MCLoadingView, NSString, UIImageView;
...
@interface MCChatImageBubble : MCChatBubble <MCChatBubbleBackgroundViewDelegate>
{
    ...
    MCLoadingView *_loadingView;
}

+ (struct CGSize)bubbleSizeForCellObject:(id)arg1 withContainer:(struct CGSize)arg2;
@property(retain, nonatomic) MCLoadingView *loadingView; // @synthesize loadingView=_loadingView;
...
- (void).cxx_destruct;
- (id)getBubbleImageWithStyle:(long long)arg1;
