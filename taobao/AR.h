...
+ (id)getSafeImage:(id)arg1 withRect:(struct CGRect)arg2;
...
- (void)openCameraWithSessionPreset:(id)arg1 result:(CDUnknownBlockType)arg2;
- (id)screenshotPath;
- (void)cleanupCache;
- (id)cacheFolder;
- (id)saveScreenshotWithBGImage:(id)arg1 base64String:(id *)arg2;
