...
@class AliDetailMultimediaBrowserViewController, NSString, TBDetailPhotoAnimationModel, UILongPressGestureRecognizer, UITapGestureRecognizer;

@interface AliProductDetailImageView : UIImageView <AliDetailMultimediaBrowserViewControllerBaseDelegate, UIActionSheetDelegate>
{
