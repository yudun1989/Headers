...
- (void)view:(id)arg1 dTextAlignment:(id)arg2;
...
- (struct CGSize)viewSizeForDWidth:(id)arg1 dHeight:(id)arg2 dMaxWidth:(id)arg3 dMaxLines:(id)arg4 dText:(id)arg5 dTextSize:(id)arg6 dTextStyle:(id)arg7;
- (id)initializeView;
