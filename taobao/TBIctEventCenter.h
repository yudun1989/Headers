...
@interface TBIctEventCenter : NSObject
{
    _Bool _destroyed;
...
- (void).cxx_destruct;
- (void)postEvent:(id)arg1 subscriber:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)postEvent:(id)arg1 completion:(CDUnknownBlockType)arg2;
