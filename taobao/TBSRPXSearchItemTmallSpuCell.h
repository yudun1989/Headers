...
@class TBSRPXSearchService, TBSearchIconViewComponent, TBSearchImageView, TBSearchPriceLabel, TBSearchPropTagView, TBSearchTmallSpuItem, TBTextAttachment, TBTextLabel, UIButton, UILabel, UIView;

@interface TBSRPXSearchItemTmallSpuCell : XSearchBaseCell
{
