...
+ (id)groupInfoUpdateResult:(id)arg1 changeFlag:(long long)arg2;
...
- (id)inerGetGroupInfoById:(id)arg1 strategy:(long long)arg2 actionBlock:(CDUnknownBlockType)arg3;
- (id)inerGetGroupInfoById:(id)arg1 strategy:(long long)arg2;
- (id)batchGroupInfo:(id)arg1;
