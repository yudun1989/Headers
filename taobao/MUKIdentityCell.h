...
@interface MUKIdentityCell : MUKSingleLineCell
{
    ...
    UIColor *_identityViewTextColor;
...
@property(retain, nonatomic) UIColor *identityViewTextColor; // @synthesize identityViewTextColor=_identityViewTextColor;
@property(copy, nonatomic) NSString *identityName; // @synthesize identityName=_identityName;
- (void).cxx_destruct;
- (void)setIdentityViewBgLeftColor:(id)arg1 rightColor:(id)arg2;
