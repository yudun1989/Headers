...
@protocol MCChatInputComponentPresenterProtocol, TBIMGroupAdapter;

@interface TBIMGroupAiTaViewController : MUKSearchCommonViewContoller <TBIMGroupServiceDelegate, MUKSearchCommonViewContollerDelegate, MCChatInputComponentPresenterDelegate>
{
    _Bool _isShowView;
    _Bool _hasAtAll;
