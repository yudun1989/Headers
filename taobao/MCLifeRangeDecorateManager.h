...
@interface MCLifeRangeDecorateManager : MCBaseDecorateManager
{
}

- (id)getRequestUniqueKeyWithIdentifiers:(id)arg1;
- (id)getRequestParamsWithIdentfiers:(id)arg1;
- (void)getTemplateFromNetworkByIdentifiers:(id)arg1 ext:(id)arg2 complete:(CDUnknownBlockType)arg3;
