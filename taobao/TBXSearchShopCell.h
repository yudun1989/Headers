...
@class NSMutableArray, NSString, TBSearchIconViewComponent, TBShopSearchResultListItem, TBShopSearchShopView, UIButton, UIImageView, UILabel, UIView;

@interface TBXSearchShopCell : TBSearchBaseCell
{
