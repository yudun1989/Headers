...
@interface TBSearchOnesearchNXConfigModel : TBJSONModel
{
    ...
    NSString *_placeholderCfg;
}

@property(retain, nonatomic) NSString *placeholderCfg; // @synthesize placeholderCfg=_placeholderCfg;
@property(retain, nonatomic) NSDictionary *requestParams; // @synthesize requestParams=_requestParams;
@property(retain, nonatomic) NSString *nx_type; // @synthesize nx_type=_nx_type;
