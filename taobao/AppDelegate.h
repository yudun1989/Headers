...
#import "TBLegalDeclarationDelegate-Protocol.h"
...
@interface AppDelegate : UIResponder <TBSafeModeDelegate, TBLegalDeclarationDelegate, WCSessionDelegate, UIApplicationDelegate>
{
...
- (void)legalDeclarationDidFinish;
