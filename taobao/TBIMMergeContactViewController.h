...
@class MCMergeContactFragment, NSString, UIButton, UIImageView, UILabel, UIView;
...
@interface TBIMMergeContactViewController : UIViewController <TBIMGroupServiceDelegate>
{
    ...
    NSString *_navibarMoreItemIcon;
    NSString *_navibarMoreItemUrl;
    NSString *_navibarRightItemIcon;
    NSString *_navibarRightItemUrl;
    NSString *_poplayerTitle;
}

@property(retain, nonatomic) NSString *poplayerTitle; // @synthesize poplayerTitle=_poplayerTitle;
@property(retain, nonatomic) NSString *navibarRightItemUrl; // @synthesize navibarRightItemUrl=_navibarRightItemUrl;
@property(retain, nonatomic) NSString *navibarRightItemIcon; // @synthesize navibarRightItemIcon=_navibarRightItemIcon;
@property(retain, nonatomic) NSString *navibarMoreItemUrl; // @synthesize navibarMoreItemUrl=_navibarMoreItemUrl;
@property(retain, nonatomic) NSString *navibarMoreItemIcon; // @synthesize navibarMoreItemIcon=_navibarMoreItemIcon;
...
@property(retain, nonatomic) NSString *mergeType; // @synthesize mergeType=_mergeType;
...
- (void).cxx_destruct;
- (void)loadMyStoreInfo;
- (void)updateNavibarForSmallStore;
- (void)clickNavibarRightItem;
- (void)clickNavibarMoreItem;
- (void)handleSingleTap:(id)arg1;
- (void)addNewUserTipForSmallStore;
- (void)setUpView;
- (void)setupFragment;
