...
@class NSDictionary, NSString, UILabel, WXSDKInstance;

@interface TBLifeCircleFoldView : UIView
{
...
@property(retain, nonatomic) UILabel *unFoldLabel; // @synthesize unFoldLabel=_unFoldLabel;
