...
@class NSCache, NSDate, NSDictionary, NSFileManager, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, TBFastImageCache;
...
@property(copy) NSDictionary *moduleCacheLevelRule; // @synthesize moduleCacheLevelRule=_moduleCacheLevelRule;
