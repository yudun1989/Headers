...
#import "MCOfficialContentFootViewProtocol-Protocol.h"
#import "MCPluginBaseProtocol-Protocol.h"

@class NSDictionary, NSString;
@protocol MCOfficialContentPresenterInterface;

@interface MCOfficialContentEmptyFootViewPlugin : NSObject <MCOfficialContentFootViewProtocol, MCPluginBaseProtocol>
{
    double _height;
