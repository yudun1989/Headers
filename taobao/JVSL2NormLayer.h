...
@interface JVSL2NormLayer : NSObject <JVSForwardLayer>
{
    NSUUID *_uuid;
    JVSTensor *_inputTensor;
    NSString *_name;
    JVSInvocation *_forwardInvocation;
    struct MetalL2NormParameter _forwardL2NormParameter;
...
+ (void)invoke:(float *)arg1 output:(float *)arg2 l2Norm:(struct MetalL2NormParameter *)arg3;
