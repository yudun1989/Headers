...
@property(retain, nonatomic) NSMutableArray *preloadedDescriptors; // @synthesize preloadedDescriptors=_preloadedDescriptors;
@property(retain, nonatomic) NSMutableDictionary *danmakuClassMap; // @synthesize danmakuClassMap=_danmakuClassMap;
