...
@interface TBIMForwardingChatSelectedViewController : MUKSearchViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, TBIMGroupServiceDelegate, UIAlertViewDelegate, MCRecentContactDataSourceDelegate, TBIMRelationServiceDelegate, MUKSearchViewControllerDelegate>
{
