...
@class NSMutableArray, TBXSearchFilterServiceModel;

@interface TBXSearchFilterServiceComponent : TBXSearchFilterBaseComponent
{
    TBXSearchFilterServiceModel *_model;
...
@property(retain, nonatomic) TBXSearchFilterServiceModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
