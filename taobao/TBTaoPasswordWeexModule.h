...
@interface TBTaoPasswordWeexModule : NSObject <WXModuleProtocol>
{
...
- (void).cxx_destruct;
- (void)closeWithParam:(id)arg1 param:(id)arg2;
- (void)getTPTaoPasswordWeexData:(CDUnknownBlockType)arg1;
