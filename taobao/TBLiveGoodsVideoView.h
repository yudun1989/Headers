...
#import "TBLiveGoodsVideoHostInfoViewDelegate-Protocol.h"

@class NSString, TBLiveGoodsVideoHostInfoView, TBLiveGoodsVideoInterActionView, TBLiveGoodsVideoPlayer, TBLiveItemVideoData, UIButton, UILabel;
@protocol TBLiveGoodsVideoViewDelegate;

@interface TBLiveGoodsVideoView : UIView <TBLiveGoodsVideoHostInfoViewDelegate, CAAnimationDelegate>
{
...
@property(retain, nonatomic) UIButton *goodCardView; // @synthesize goodCardView=_goodCardView;
