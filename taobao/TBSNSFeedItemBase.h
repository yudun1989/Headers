...
@interface TBSNSFeedItemBase : TBJSONModel
{
    ...
    NSString *_interactTagType;
    NSString *_interactIcon;
    NSString *_interactText;
    NSString *_interactTargetUrl;
...
@property(retain, nonatomic) NSString *interactTargetUrl; // @synthesize interactTargetUrl=_interactTargetUrl;
@property(retain, nonatomic) NSString *interactText; // @synthesize interactText=_interactText;
@property(retain, nonatomic) NSString *interactIcon; // @synthesize interactIcon=_interactIcon;
@property(retain, nonatomic) NSString *interactTagType; // @synthesize interactTagType=_interactTagType;
