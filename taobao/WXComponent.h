...
@class CALayer, MAShape, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, UIColor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WXBoxShadow, WXSDKInstance, WXThreadSafeCounter, WXTouchGestureRecognizer, WXTransform, WXTransition;
...
- (id)subcomponentOfClass:(Class)arg1;
