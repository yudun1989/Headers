...
@interface TBPSWXOperationActivityModule : NSObject <WXModuleProtocol>
{
...
- (void)updateActivityID:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
