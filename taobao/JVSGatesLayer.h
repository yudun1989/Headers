...
@interface JVSGatesLayer : NSObject <JVSForwardLayer>
{
    NSUUID *_uuid;
    ...
    struct MetalGatesParameter _forwardGatesParameter;
...
@property(copy, nonatomic) NSString *activation; // @synthesize activation=_activation;
