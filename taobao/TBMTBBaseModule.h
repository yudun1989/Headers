...
@class NSString, TBMTBCardCfg, TBMTBDefaultCfg, TBMTBTemplate;
...
@interface TBMTBBaseModule : TBJSONModel
{
    ...
    TBMTBTemplate *_template;
    NSString *_background;
}

@property(retain, nonatomic) NSString *background; // @synthesize background=_background;
@property(retain, nonatomic) TBMTBTemplate *template; // @synthesize template=_template;
