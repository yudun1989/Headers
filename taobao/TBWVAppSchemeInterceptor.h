...
@interface TBWVAppSchemeInterceptor : NSObject <WVRequestInterceptorProtocol>
{
}

+ (_Bool)isInWhiteList:(id)arg1;
+ (_Bool)webView:(id)arg1 canInterceptRequest:(id)arg2;
+ (_Bool)isInBlackList:(id)arg1;
+ (id)sharedInstance;
- (_Bool)isAllowOpenClient:(id)arg1;
