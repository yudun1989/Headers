...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, PodWBCloudFaceVerifySDK_AFNetworkReachabilityManager, PodWBCloudFaceVerifySDK_AFSecurityPolicy;
@protocol AFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface PodWBCloudFaceVerifySDK_AFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <AFURLResponseSerialization> _responseSerializer;
    PodWBCloudFaceVerifySDK_AFSecurityPolicy *_securityPolicy;
    PodWBCloudFaceVerifySDK_AFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) PodWBCloudFaceVerifySDK_AFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) PodWBCloudFaceVerifySDK_AFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
