...
@interface SDImageCache : NSObject <AFImageCache>
{
...
- (id)init;
- (id)queryDiskCacheForKey:(id)arg1 cancellationToken:(id)arg2;
- (id)ks_mainImageFromFeed:(id)arg1;
- (_Bool)ks_mainImageExistedForFeed:(id)arg1;
- (id)ks_placeholderImageFromFeed:(id)arg1;
- (_Bool)ks_placeholderImageExistedForFeed:(id)arg1;
- (id)ks_thumbnailImageFromFeed:(id)arg1;
