...
@interface KSULocationPackage : GPBMessage
{
}
...
@property(copy, nonatomic) NSString *county; // @dynamic county;
...
@property(copy, nonatomic) NSString *unnormalized; // @dynamic unnormalized;
