...
@interface HLTagAttributeProcesser : NSObject <HLAttributedStringProcesserInterface>
{
...
+ (void)configTextViewAttributedString:(id)arg1 tagColor:(id)arg2;
+ (id)tagsFromStirng:(id)arg1;
+ (id)sharedHLTagAttributeProcesser;
