...
@class NSMutableURLRequest, NSString, PodWBCloudFaceVerifySDK_AFMultipartBodyStream;

@interface PodWBCloudFaceVerifySDK_AFStreamingMultipartFormData : NSObject <AFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    PodWBCloudFaceVerifySDK_AFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) PodWBCloudFaceVerifySDK_AFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
