...
@interface WBFaceWeakTimer : NSObject
{
    struct {
...
+ (id)scheduledTimerWithTimeInterval:(double)arg1 target:(id)arg2 selector:(SEL)arg3 userInfo:(id)arg4 repeats:(_Bool)arg5 repeatCount:(int)arg6 dispatchQueue:(id)arg7;
...
- (void)dealloc;
- (id)init;
- (id)initWithTimeInterval:(double)arg1 target:(id)arg2 selector:(SEL)arg3 userInfo:(id)arg4 repeats:(_Bool)arg5 repeatCount:(int)arg6 dispatchQueue:(id)arg7;
