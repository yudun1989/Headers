...
@class GLProgram, NSArray, NSMutableDictionary, NSObject, NSString;
@protocol OS_dispatch_semaphore;

@interface GPUImageNInputFilter : GPUImageOutput <GPUImageInput>
{
...
- (void)setPointArray:(float *)arg1 length:(int)arg2 forUniform:(int)arg3 program:(id)arg4;
- (void)setIntArray:(int *)arg1 length:(int)arg2 forUniform:(int)arg3 program:(id)arg4;
...
@property(readonly, nonatomic) long long inputNumber;
- (void)disableFrameCheckAtIndexSet:(id)arg1;
- (id)initWithInputNumber:(long long)arg1 vertexShaderFromString:(id)arg2 fragmentShaderFromString:(id)arg3;
- (id)initWithInputNumber:(long long)arg1 fragmentShaderFromString:(id)arg2 extendVertexShaderFromString:(id)arg3;
- (id)initWithInputNumber:(long long)arg1 fragmentShaderFromString:(id)arg2;
- (id)vertexShaderStringForInputNumber:(long long)arg1 extend:(id)arg2;
