...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, PodWBCloudFaceVerifySDK_AFHTTPBodyPart;
@protocol NSStreamDelegate;

@interface PodWBCloudFaceVerifySDK_AFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    PodWBCloudFaceVerifySDK_AFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) PodWBCloudFaceVerifySDK_AFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
