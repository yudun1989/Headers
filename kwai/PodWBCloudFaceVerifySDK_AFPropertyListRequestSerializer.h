...
#import "PodWBCloudFaceVerifySDK_AFHTTPRequestSerializer.h"

@interface PodWBCloudFaceVerifySDK_AFPropertyListRequestSerializer : PodWBCloudFaceVerifySDK_AFHTTPRequestSerializer
{
