...
+ (id)taskForCompletionOfAllTasks:(id)arg1 errorKeys:(id)arg2 errorDomain:(id)arg3 errorCode:(long long)arg4;
+ (id)ks_coverUploadTaskWithCoverImageContent:(id)arg1 type:(unsigned long long)arg2 progress:(id *)arg3 cancellationToken:(id)arg4 host:(id *)arg5 ip:(id *)arg6;
+ (id)ks_arrayReduce:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
