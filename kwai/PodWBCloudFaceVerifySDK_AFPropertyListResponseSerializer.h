...
#import "PodWBCloudFaceVerifySDK_AFHTTPResponseSerializer.h"

@interface PodWBCloudFaceVerifySDK_AFPropertyListResponseSerializer : PodWBCloudFaceVerifySDK_AFHTTPResponseSerializer
{
