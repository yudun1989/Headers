...
- (void)startLoginWithWeb:(_Bool)arg1 safariViewController:(_Bool)arg2 permissions:(id)arg3;
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
- (void)startWebLoginWithSafariViewController:(_Bool)arg1 permissions:(id)arg2;
- (void)startLoginWithPermissions:(id)arg1;
- (void)startWebLoginWithSafariViewController:(_Bool)arg1;
- (void)startLogin;
