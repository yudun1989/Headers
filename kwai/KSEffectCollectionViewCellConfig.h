...
@interface KSEffectCollectionViewCellConfig : NSObject
{
    _Bool _selected;
    long long _foregroundImageContentMode;
...
@property(nonatomic) long long foregroundImageContentMode; // @synthesize foregroundImageContentMode=_foregroundImageContentMode;
- (void).cxx_destruct;
