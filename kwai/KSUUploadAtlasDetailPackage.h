...
@interface KSUUploadAtlasDetailPackage : GPBMessage
{
}
...
@property(nonatomic) unsigned int elementCount; // @dynamic elementCount;
@property(nonatomic) unsigned long long encodeConfigId; // @dynamic encodeConfigId;
@property(nonatomic) unsigned int failedElementCount; // @dynamic failedElementCount;
...
@property(nonatomic) unsigned int pictureCount; // @dynamic pictureCount;
