...
@protocol GISSimplePingDelegate;

@interface GISSimplePing : NSObject
{
    _Bool _nextSequenceNumberHasWrapped;
    unsigned short _identifier;
    unsigned short _nextSequenceNumber;
    NSString *_hostName;
    id <GISSimplePingDelegate> _delegate;
...
@property(nonatomic) __weak id <GISSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
