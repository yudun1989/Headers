...
@class NSMutableData, NSProgress, NSString, NSURL, PodWBCloudFaceVerifySDK_AFURLSessionManager;

@interface PodWBCloudFaceVerifySDK_AFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    PodWBCloudFaceVerifySDK_AFURLSessionManager *_manager;
...
@property(nonatomic) __weak PodWBCloudFaceVerifySDK_AFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
