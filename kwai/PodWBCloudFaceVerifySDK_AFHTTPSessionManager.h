...
#import "PodWBCloudFaceVerifySDK_AFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSURL, PodWBCloudFaceVerifySDK_AFHTTPRequestSerializer, PodWBCloudFaceVerifySDK_AFHTTPResponseSerializer;
@protocol AFURLRequestSerialization, AFURLResponseSerialization;

@interface PodWBCloudFaceVerifySDK_AFHTTPSessionManager : PodWBCloudFaceVerifySDK_AFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    PodWBCloudFaceVerifySDK_AFHTTPRequestSerializer<AFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) PodWBCloudFaceVerifySDK_AFHTTPRequestSerializer<AFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) PodWBCloudFaceVerifySDK_AFHTTPResponseSerializer<AFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
