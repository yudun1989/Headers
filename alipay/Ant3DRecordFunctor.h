...
#import "Ant3DMicSourceDelegate-Protocol.h"

@class APMVideoWriter, Ant3DContext, Ant3DMicSource, NSString;
@protocol Ant3DRecordFunctorDelegate, OS_dispatch_queue;
