...
@class AVCaptureAudioDataOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, NSError, NSString;
@protocol APFCameraServiceDelegate, OS_dispatch_queue;
