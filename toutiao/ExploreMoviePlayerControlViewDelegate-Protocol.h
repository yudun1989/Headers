...
@class NSSet, NSString, UIEvent, UIView;
...
- (void)controlViewShareActionClicked:(UIView *)arg1 withActivityType:(NSString *)arg2;
- (void)controlViewMoreButtonClicked:(UIView *)arg1;
@end
