...
#import "TTMoviePlayerLayerViewDelegate-Protocol.h"
#import "TTPlayer-Protocol.h"

@class AVPlayer, AVPlayerItem, AVURLAsset, NSString, NSURL, TTAVMoviePlayerController, TTAVPlayerItemAccessLog, TTMoviePlayerLayerView, UIView;
@protocol AVAssetResourceLoaderDelegate, TTPlayerDelegate;
