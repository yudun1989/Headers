...
@class CommentInputViewController, NSString, TTGroupModel, TTThirdPartyAccountInfoBase, UIViewController;
...
@interface _TTShareManagerSendSNSObject : NSObject <CommentInputViewControllerDelegate>
{
    ...
    TTThirdPartyAccountInfoBase *_accountInfoBase;
...
@property(retain, nonatomic) TTThirdPartyAccountInfoBase *accountInfoBase; // @synthesize accountInfoBase=_accountInfoBase;
