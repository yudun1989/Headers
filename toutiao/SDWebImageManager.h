...
@class NSMutableArray, NSMutableSet, SDImageCache, SDWebImageDownloader, SDWebImagePrefetcher;
...
- (id)init;
@property(nonatomic) __weak SDWebImagePrefetcher *sda_imagePrefetcher;
