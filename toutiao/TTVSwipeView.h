...
@interface TTVSwipeView : UIView <UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    id <TTVSwipeViewDataSource> _dataSource;
    id <TTVSwipeViewDelegate> _delegate;
...
@property(nonatomic) __weak id <TTVSwipeViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <TTVSwipeViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
