...
@class FRPublishPostSearchHashtagHotStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcPublishPostV1HotForumResponseModel : TTResponseModel
{
    ...
    FRPublishPostSearchHashtagHotStructModel *_data;
}

@property(retain, nonatomic) FRPublishPostSearchHashtagHotStructModel *data; // @synthesize data=_data;
