...
@interface TTCommentModel : JSONModel <TTCommentModelProtocol>
{
    ...
    NSString<Optional> *_userDecorator;
    ...
    NSDictionary<Optional> *_trackerDic;
...
@property(copy, nonatomic) NSDictionary<Optional> *trackerDic; // @synthesize trackerDic=_trackerDic;
...
@property(copy, nonatomic) NSString<Optional> *userDecorator; // @synthesize userDecorator=_userDecorator;
...
- (id)initWithCommentRepostDictionary:(id)arg1;
