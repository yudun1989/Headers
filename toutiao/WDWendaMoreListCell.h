...
@class NSDictionary, NSString, SSThemedLabel, SSThemedView, TTTAttributedLabel, WDAnswerEntity, WDMoreListCellLayoutModel, WDMoreListCellViewModel, WDWendaListCellInputCommentView, WDWendaListCellUserHeaderView;
@protocol WDListCellActionDelegate, WDListCellLayoutModelBaseProtocol;

@interface WDWendaMoreListCell : SSThemedTableViewCell <WDWendaListCellUserHeaderViewDelegate, TTTAttributedLabelDelegate, WDListCellBaseProtocol>
{
