...
@protocol Optional, WDSearchUserStructModel><Optional;

@interface WDWendaSearchInvitelistResponseModel : TTResponseModel
{
    NSNumber<Optional> *_err_no;
    NSString<Optional> *_err_tips;
    NSArray<WDSearchUserStructModel><Optional> *_user_list;
}

@property(copy, nonatomic) NSArray<WDSearchUserStructModel><Optional> *user_list; // @synthesize user_list=_user_list;
