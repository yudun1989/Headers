...
@class KDDetailPermStructModel, NSNumber, NSString;
@protocol Optional;

@interface KDDetailWendaStructModel : WDBaseModel
{
    NSNumber *_ansid;
    NSNumber *_ans_count;
    NSNumber *_digg_count;
    NSNumber *_brow_count;
    KDDetailPermStructModel *_perm;
...
@property(retain, nonatomic) KDDetailPermStructModel *perm; // @synthesize perm=_perm;
