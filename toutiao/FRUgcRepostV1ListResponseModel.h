...
@protocol FRFooterRepostStructModel><Optional, Optional;
...
@interface FRUgcRepostV1ListResponseModel : TTResponseModel
{
    ...
    NSArray<FRFooterRepostStructModel><Optional> *_reposts;
    NSArray<FRFooterRepostStructModel><Optional> *_stick_reposts;
}

@property(retain, nonatomic) NSArray<FRFooterRepostStructModel><Optional> *stick_reposts; // @synthesize stick_reposts=_stick_reposts;
@property(retain, nonatomic) NSArray<FRFooterRepostStructModel><Optional> *reposts; // @synthesize reposts=_reposts;
