...
@class NSDate, NSDictionary, NSString, TencentOAuth;

@interface TTAccountAuthTencent : NSObject <TencentSessionDelegate, TTACustomWapAuthViewControllerDelegate, TTAccountAuthProtocol>
{
...
- (_Bool)isAuthorizing;
- (void)sdkAuthorizeWithScope:(id)arg1 customUserInfo:(id)arg2;
