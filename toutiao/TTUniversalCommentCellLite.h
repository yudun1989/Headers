...
@class DetailActionRequestManager, NSArray, NSDictionary, NSString, SSThemedButton, TTActionSheetController, TTAlphaThemedButton, TTAsyncCornerImageView, TTAsyncLabel, TTCommentReplyListView, TTDiggButton, TTUGCAttributedLabel, TTUniversalCommentLayout, TTUserInfoView;
@protocol TTCommentCellDelegate, TTCommentModelProtocol;

@interface TTUniversalCommentCellLite : SSThemedTableViewCell <TTUGCAttributedLabelDelegate>
{
