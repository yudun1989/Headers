...
@class NSString, TTDirectForwardWeitoutiaoContentItem, UIViewController;

@interface TTDirectForwardWeitoutiaoActivity : NSObject <TTActivityProtocol>
{
    TTDirectForwardWeitoutiaoContentItem *_contentItem;
}

+ (void)load;
@property(retain, nonatomic) TTDirectForwardWeitoutiaoContentItem *contentItem; // @synthesize contentItem=_contentItem;
- (void).cxx_destruct;
- (id)shareLabel;
