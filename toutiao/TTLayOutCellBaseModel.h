...
@interface TTLayOutCellBaseModel : NSObject
{
    ...
    _Bool _adInnerLoopPicViewHidden;
    _Bool _motionViewHidden;
    _Bool _isExpand;
    ...
    unsigned long long _adLocationTruncateStyle;
    ...
    struct CGSize _adInnerLoopPerPicSize;
    ...
    struct CGRect _adInnerLoopPicViewFrame;
    struct CGRect _motionViewFrame;
}
...
@property(nonatomic) _Bool motionViewHidden; // @synthesize motionViewHidden=_motionViewHidden;
@property(nonatomic) struct CGRect motionViewFrame; // @synthesize motionViewFrame=_motionViewFrame;
@property(nonatomic) struct CGSize adInnerLoopPerPicSize; // @synthesize adInnerLoopPerPicSize=_adInnerLoopPerPicSize;
@property(nonatomic) struct CGRect adInnerLoopPicViewFrame; // @synthesize adInnerLoopPicViewFrame=_adInnerLoopPicViewFrame;
@property(nonatomic) _Bool adInnerLoopPicViewHidden; // @synthesize adInnerLoopPicViewHidden=_adInnerLoopPicViewHidden;
...
@property(nonatomic) unsigned long long adLocationTruncateStyle; // @synthesize adLocationTruncateStyle=_adLocationTruncateStyle;
...
@property(retain, nonatomic) NSString *typeLabelStr; // @synthesize typeLabelStr=_typeLabelStr;
...
@property(nonatomic) _Bool needHeaderDislike; // @synthesize needHeaderDislike=_needHeaderDislike;
...
@property(nonatomic) _Bool needMultiDiggAnimation; // @synthesize needMultiDiggAnimation=_needMultiDiggAnimation;
