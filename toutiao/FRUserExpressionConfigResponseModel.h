...
@class FRUserExpressionConfigStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUserExpressionConfigResponseModel : TTResponseModel
{
    ...
    FRUserExpressionConfigStructModel<Optional> *_data;
}

@property(retain, nonatomic) FRUserExpressionConfigStructModel<Optional> *data; // @synthesize data=_data;
