...
@class NSString;
@protocol TTWebImageCoder;

@interface TTWebImageDecoder : NSObject <TTWebImageCoder>
{
    id <TTWebImageCoder> _incrementalCoder;
}

+ (id)sharedCoder;
@property(retain, nonatomic) id <TTWebImageCoder> incrementalCoder; // @synthesize incrementalCoder=_incrementalCoder;
- (void).cxx_destruct;
