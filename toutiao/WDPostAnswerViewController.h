...
#import "WDPostAnswerGuideAuthorViewDelegate-Protocol.h"
#import "WDPostAnswerPopUpViewDelegate-Protocol.h"
#import "WDPostAnswerSettingViewDelegate-Protocol.h"
#import "WDPostAnswerViewModelDelegate-Protocol.h"
#import "WDWendaFirstWritterPopupViewDelegate-Protocol.h"

@class NSDate, NSDictionary, NSMutableDictionary, NSString, SSThemedButton, SSThemedImageView, SSThemedLabel, TTIndicatorView, TTRichEditorView, UIView, WDFetchTipsStructModel, WDInputAccessoryView, WDPostAnswerHeaderView, WDPostAnswerViewModel;

@interface WDPostAnswerViewController : SSViewControllerBase <TTRichEditorViewDelegate, UINavigationControllerDelegate, WDWendaFirstWritterPopupViewDelegate, UIViewControllerErrorHandler, WDPostAnsSectionHeaderViewDelegate, TTImagePickerControllerDelegate, WDPostAnswerViewModelDelegate, WDPostAnswerSettingViewDelegate, WDPostAnswerGuideAuthorViewDelegate, WDPostAnswerPopUpViewDelegate>
{
    _Bool _isRedirect;
    ...
    _Bool _showWriteAnswerTips;
    _Bool _showChooseImageTips;
    NSString *_qTitle;
    NSString *_qid;
    NSString *_ansid;
    NSString *_source;
    ...
    WDFetchTipsStructModel *_answerTipsModel;
    NSDate *_startDate;
...
+ (void)load;
@property(retain, nonatomic) NSMutableDictionary *personDict; // @synthesize personDict=_personDict;
@property(retain, nonatomic) NSDate *startDate; // @synthesize startDate=_startDate;
@property(retain, nonatomic) WDFetchTipsStructModel *answerTipsModel; // @synthesize answerTipsModel=_answerTipsModel;
@property(nonatomic) _Bool showChooseImageTips; // @synthesize showChooseImageTips=_showChooseImageTips;
@property(nonatomic) _Bool showWriteAnswerTips; // @synthesize showWriteAnswerTips=_showWriteAnswerTips;
...
- (void).cxx_destruct;
- (_Bool)settingViewShouldBanComment:(id)arg1;
- (void)settingView:(id)arg1 banCommentDidChange:(_Bool)arg2;
- (void)popUpViewDismissed:(id)arg1;
- (void)popUpView:(id)arg1 confirmWithTitle:(id)arg2 linkUrl:(id)arg3;
- (void)afterSelectUserVCDismiss;
- (void)selectOneUser:(id)arg1;
- (void)editorViewDidTriggerSelectAtUser:(id)arg1;
...
- (void)postAnswerGuideAuthorViewCloseButtonTapped:(id)arg1;
