...
@class ArticleDetail, ExploreOrderedADModel, NSArray, NSDate, NSDictionary, NSNumber, NSString, TTAdFeedModel, TTAdVideoRelateAdModel, TTFriendRelationEntity;
@protocol FRActionDataProtocol, TTAdFeedModel;

@interface Article : ExploreOriginalData <TTVArticleProtocol, TTAdDetailInnerArticleProtocol, TTFriendRelationValueChangedProtocol>
{
    int _displayType;
    ...
    NSString *_titleRichSpanJSONString;
    id <FRActionDataProtocol> _actionDataModel;
    NSString *_navTitleType;
    NSString *_navTitleUrl;
    NSString *_navTitleNightUrl;
    NSString *_navOpenUrl;
    NSString *_adIDStr;
    NSString *_logExtra;
...
@property(copy, nonatomic) NSString *adIDStr; // @synthesize adIDStr=_adIDStr;
@property(copy, nonatomic) NSString *navOpenUrl; // @synthesize navOpenUrl=_navOpenUrl;
@property(copy, nonatomic) NSString *navTitleNightUrl; // @synthesize navTitleNightUrl=_navTitleNightUrl;
@property(copy, nonatomic) NSString *navTitleUrl; // @synthesize navTitleUrl=_navTitleUrl;
@property(copy, nonatomic) NSString *navTitleType; // @synthesize navTitleType=_navTitleType;
@property(retain, nonatomic) id <FRActionDataProtocol> actionDataModel; // @synthesize actionDataModel=_actionDataModel;
@property(copy, nonatomic) NSString *titleRichSpanJSONString; // @synthesize titleRichSpanJSONString=_titleRichSpanJSONString;
@property(retain, nonatomic) NSDictionary *payStatus; // @synthesize payStatus=_payStatus;
...
@property(retain, nonatomic) NSDictionary *ugcVideoCover; // @synthesize ugcVideoCover=_ugcVideoCover;
...
@property(nonatomic) _Bool detailShowFlags; // @synthesize detailShowFlags=_detailShowFlags;
@property(retain, nonatomic) NSNumber *picDisplayType; // @synthesize picDisplayType=_picDisplayType;
...
@property(copy, nonatomic) NSString *adPromoter; // @synthesize adPromoter=_adPromoter;
...
@property(retain, nonatomic) NSArray *galleryAdditional; // @synthesize galleryAdditional=_galleryAdditional;
...
- (void)save;
- (long long)articlePictureDidsplayType;
...
- (void)setExploreAdModel:(id)arg1;
@property(readonly, nonatomic) ExploreOrderedADModel *exploreAdModel;
- (void)setRawAd:(id)arg1;
@property(readonly, nonatomic) TTAdFeedModel *rawAd;
...
@property(nonatomic) _Bool detailInfoUpdated;
@property(readonly, nonatomic) NSString *mediaID;
@property(nonatomic) _Bool convertedFromFeedItem;
