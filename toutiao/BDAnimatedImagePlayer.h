...
@class BDAnimateImageFrame, BDImage, CADisplayLink, NSMutableDictionary, NSMutableIndexSet, NSNumber;
...
@property(retain, nonatomic) NSNumber *lastPlayedIndex; // @synthesize lastPlayedIndex=_lastPlayedIndex;
...
- (void)nextFrame;
- (unsigned long long)nextFrameIndex:(id)arg1;
