...
@property(retain, nonatomic) NSNumber *opt_id; // @synthesize opt_id=_opt_id;
@property(retain, nonatomic) NSNumber *fw_user_id; // @synthesize fw_user_id=_fw_user_id;
@property(nonatomic) long long fw_id_type; // @synthesize fw_id_type=_fw_id_type;
@property(retain, nonatomic) NSNumber *fw_id; // @synthesize fw_id=_fw_id;
