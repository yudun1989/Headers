...
@class SSThemedLabel, TTAlphaThemedButton, TTAsyncCornerImageView, TTFollowThemeButton, UIView;
@protocol TTVDetailFollowRecommendCardCellDelegate, TTVDetailRelatedRecommendCellViewModelProtocol;

@interface TTVDetailFollowRecommendCardCell : UICollectionViewCell
{
    id <TTVDetailRelatedRecommendCellViewModelProtocol> _model;
    TTAlphaThemedButton *_dislikeButton;
    id <TTVDetailFollowRecommendCardCellDelegate> _delegate;
...
@property(nonatomic) __weak id <TTVDetailFollowRecommendCardCellDelegate> delegate; // @synthesize delegate=_delegate;
@property(readonly, nonatomic) TTAlphaThemedButton *dislikeButton; // @synthesize dislikeButton=_dislikeButton;
@property(retain, nonatomic) id <TTVDetailRelatedRecommendCellViewModelProtocol> model; // @synthesize model=_model;
- (void).cxx_destruct;
