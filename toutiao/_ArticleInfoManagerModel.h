...
@class FRActivityStructModel, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, TTActivityModel;
@protocol Ignore, NSDictionary, Optional;
...
@interface _ArticleInfoManagerModel : JSONModel
{
    ...
    NSString<Optional> *_ug_install_aid;
}

+ (_Bool)propertyIsOptional:(id)arg1;
+ (id)keyMapper;
@property(copy, nonatomic) NSString<Optional> *ug_install_aid; // @synthesize ug_install_aid=_ug_install_aid;
