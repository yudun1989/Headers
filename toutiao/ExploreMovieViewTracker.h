...
@class NSArray, NSDictionary, NSMutableDictionary, NSNumber, NSString, SSMoviePlayerController, TTGroupModel, UIView;
...
- (void)addExtraValueFromDic:(id)arg1;
...
- (void)sendVideoOverEventV3WithLabel:(id)arg1 andDuration:(long long)arg2 isDoubleSend:(_Bool)arg3;
- (void)sendVideoPlayEventV3WithLabel:(id)arg1 isDoubleSending:(_Bool)arg2;
