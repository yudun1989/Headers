...
@class FRUserRelationContactCheckDataStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUserRelationContactcheckResponseModel : TTResponseModel
{
    ...
    FRUserRelationContactCheckDataStructModel *_data;
}

@property(retain, nonatomic) FRUserRelationContactCheckDataStructModel *data; // @synthesize data=_data;
