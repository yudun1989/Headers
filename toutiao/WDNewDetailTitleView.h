...
@interface WDNewDetailTitleView : SSThemedView <UIGestureRecognizerDelegate>
{
    _Bool _isShow;
    _Bool _isAnimating;
...
- (void)showVerifyIconWithVerifyInfo:(id)arg1 decoration:(id)arg2 logoViewIsHiden:(_Bool)arg3;
- (void)updateNavigationTitle:(id)arg1 imageURL:(id)arg2 verifyInfo:(id)arg3 decoration:(id)arg4 fansNum:(long long)arg5;
