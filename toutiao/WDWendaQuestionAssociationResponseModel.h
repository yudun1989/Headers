...
@protocol Optional, WDSimpleQuestionStructModel><Optional;

@interface WDWendaQuestionAssociationResponseModel : TTResponseModel
{
    NSNumber<Optional> *_err_no;
    NSString<Optional> *_err_tips;
    NSArray<WDSimpleQuestionStructModel><Optional> *_question_list;
    NSString<Optional> *_title;
}

@property(retain, nonatomic) NSString<Optional> *title; // @synthesize title=_title;
@property(copy, nonatomic) NSArray<WDSimpleQuestionStructModel><Optional> *question_list; // @synthesize question_list=_question_list;
