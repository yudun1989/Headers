...
@class NSArray, NSDictionary, NSString, SSThemedLabel, SSThemedView, TTImageView, WDAnswerEntity, WDListCellLayoutModel, WDListCellViewModel, WDWendaListCellActionFooterView, WDWendaListCellExcellentCommentView, WDWendaListCellInputCommentView, WDWendaListCellPureCharacterView, WDWendaListCellUserHeaderView;
@protocol WDListCellActionDelegate, WDListCellLayoutModelBaseProtocol;

@interface WDWendaListLightMultiImageCell : SSThemedTableViewCell <WDWendaListCellUserHeaderViewDelegate, WDWendaListCellActionFooterViewDelegate, UIGestureRecognizerDelegate, WDWendaListCellInputCommentViewDelegate, WDListCellBaseProtocol>
{
