...
@class HTSFilterInterface, HTSGLFilterInput, HTSGLMovieWriter, HTSVideoData;
...
@property(retain, nonatomic) HTSGLMovieWriter *movieWriter; // @synthesize movieWriter=_movieWriter;
