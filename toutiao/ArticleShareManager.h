...
+ (id)shareActivityManager:(id)arg1 setWapConditionWithTitle:(id)arg2 desc:(id)arg3 url:(id)arg4 imageUrl:(id)arg5 shareType:(unsigned long long)arg6;
+ (id)shareActivityManager:(id)arg1 shareInfo:(id)arg2 showReport:(_Bool)arg3 withQQ:(_Bool)arg4;
...
+ (id)shareActivityManager:(id)arg1 shareModel:(id)arg2 showReport:(_Bool)arg3;
+ (id)shareActivityManager:(id)arg1 setArticleCondition:(id)arg2 adID:(id)arg3 showReport:(_Bool)arg4 withQQ:(_Bool)arg5;
