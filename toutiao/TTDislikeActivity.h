...
@class NSString, TTDislikeContentItem, UIViewController;

@interface TTDislikeActivity : NSObject <TTActivityProtocol>
{
    TTDislikeContentItem *_contentItem;
}

+ (void)load;
@property(retain, nonatomic) TTDislikeContentItem *contentItem; // @synthesize contentItem=_contentItem;
- (void).cxx_destruct;
