...
@protocol TTChatroomMoviePlayerControlSliderViewDelegate;

@interface TTChatroomMoviePlayerControlSliderView : UIView
{
    _Bool _enableDrag;
    _Bool _duringDrag;
    _Bool _isFull;
    ...
    id <TTChatroomMoviePlayerControlSliderViewDelegate> _delegate;
...
@property(nonatomic) __weak id <TTChatroomMoviePlayerControlSliderViewDelegate> delegate; // @synthesize delegate=_delegate;
