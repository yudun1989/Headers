...
+ (id)createCommentModelWithCommentRepostDic:(id)arg1;
+ (id)createEntitiesWithArray:(id)arg1 groupModel:(id)arg2;
+ (id)createWithCommentStructModel:(id)arg1 groupModel:(id)arg2;
+ (id)createWithCommentDataStructModel:(id)arg1 groupModel:(id)arg2;
...
@property(copy, nonatomic) NSString *userDecorator; // @synthesize userDecorator=_userDecorator;
