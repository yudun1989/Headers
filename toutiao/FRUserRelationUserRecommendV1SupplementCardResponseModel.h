...
@class FRRecommendCardStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUserRelationUserRecommendV1SupplementCardResponseModel : TTResponseModel
{
    ...
    FRRecommendCardStructModel<Optional> *_data;
}

@property(retain, nonatomic) FRRecommendCardStructModel<Optional> *data; // @synthesize data=_data;
