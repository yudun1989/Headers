...
@class FRFollowInfoStructModel, FRForumItemStructModel, FRGeographyStructModel, FRGroupInfoStructModel, FRGroupStructModel, FRUGCVideoDataStructModel, FRUserStructModel, NSArray, NSNumber, NSString;
@protocol FRActionStructModel><Optional, FRCommentStructModel><Optional, FRHashTagPositionStructModel><Optional, FRImageUrlStructModel><Optional, FRUserStructModel><Optional, Optional;
...
@interface FRUgcDataStructModel : JSONModel
{
    ...
    NSString<Optional> *_brand_info;
    NSString<Optional> *_content_decoration;
}

@property(retain, nonatomic) NSString<Optional> *content_decoration; // @synthesize content_decoration=_content_decoration;
@property(retain, nonatomic) NSString<Optional> *brand_info; // @synthesize brand_info=_brand_info;
