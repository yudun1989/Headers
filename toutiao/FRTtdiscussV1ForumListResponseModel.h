...
@class FRForumStructModel, FRLoginUserInfoStructModel, FRTipsStructModel, NSArray, NSNumber, NSString;
@protocol FRGeneralThreadStructModel><Optional, FRTabStructModel><Optional, FRThreadDataStructModel><Optional, Optional;
