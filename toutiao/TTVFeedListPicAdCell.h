...
@class TTVFeedListAdBottomContainerView, TTVFeedListAdPicTopContainerView;

@interface TTVFeedListPicAdCell : TTVFeedListCell
{
    TTVFeedListAdPicTopContainerView *_topContainerView;
...
@property(retain, nonatomic) TTVFeedListAdPicTopContainerView *topContainerView; // @synthesize topContainerView=_topContainerView;
- (void).cxx_destruct;
