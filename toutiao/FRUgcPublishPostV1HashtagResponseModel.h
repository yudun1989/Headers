...
@class FRPublishPostSearchHashtagSuggestStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcPublishPostV1HashtagResponseModel : TTResponseModel
{
    ...
    FRPublishPostSearchHashtagSuggestStructModel *_data;
}

@property(retain, nonatomic) FRPublishPostSearchHashtagSuggestStructModel *data; // @synthesize data=_data;
