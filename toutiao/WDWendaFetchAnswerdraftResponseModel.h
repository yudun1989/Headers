...
@class NSNumber, NSString, WDAnswerDraftStructModel;
@protocol Optional;
...
@interface WDWendaFetchAnswerdraftResponseModel : TTResponseModel
{
    ...
    WDAnswerDraftStructModel<Optional> *_answer;
}

@property(retain, nonatomic) WDAnswerDraftStructModel<Optional> *answer; // @synthesize answer=_answer;
