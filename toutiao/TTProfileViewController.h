...
@interface TTProfileViewController : SSViewControllerBase <UIScrollViewDelegate, TTAccountMulticastProtocol>
{
    _Bool _backButtonClicked;
    _Bool _resurfaceIconAnimated;
...
@property(nonatomic) _Bool resurfaceIconAnimated; // @synthesize resurfaceIconAnimated=_resurfaceIconAnimated;
...
@property(copy, nonatomic) NSString *fromTab; // @synthesize fromTab=_fromTab;
...
- (void)resurfaceBtnTouched:(id)arg1;
