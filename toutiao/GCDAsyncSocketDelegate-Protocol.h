...
@class EAccountGCDAsyncSocket, NSData, NSError, NSObject, NSString, NSURL;
...
- (void)socket:(EAccountGCDAsyncSocket *)arg1 didConnectToUrl:(NSURL *)arg2;
...
- (NSObject<OS_dispatch_queue> *)newSocketQueueForConnectionFromAddress:(NSData *)arg1 onSocket:(EAccountGCDAsyncSocket *)arg2;
@end
