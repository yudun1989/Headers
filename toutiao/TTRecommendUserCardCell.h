...
@class FRRecommendCardStructModel, SSThemedLabel, TTAlphaThemedButton, TTAsyncCornerImageView, TTFollowThemeButton, UIView;
@protocol TTRecommendUserCardCellDelegate;

@interface TTRecommendUserCardCell : UICollectionViewCell
{
    FRRecommendCardStructModel *_model;
    TTAlphaThemedButton *_dislikeButton;
    id <TTRecommendUserCardCellDelegate> _delegate;
...
@property(nonatomic) __weak id <TTRecommendUserCardCellDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) TTAlphaThemedButton *dislikeButton; // @synthesize dislikeButton=_dislikeButton;
@property(retain, nonatomic) FRRecommendCardStructModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
