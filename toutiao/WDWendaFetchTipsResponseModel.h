...
@class NSNumber, NSString, WDFetchTipsStructModel;
@protocol Optional;
...
@interface WDWendaFetchTipsResponseModel : TTResponseModel
{
    ...
    WDFetchTipsStructModel<Optional> *_tips;
}

@property(retain, nonatomic) WDFetchTipsStructModel<Optional> *tips; // @synthesize tips=_tips;
