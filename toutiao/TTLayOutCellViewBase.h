...
#import "TTDislikePopViewDelegate-Protocol.h"
#import "TTLabelTappingDelegate-Protocol.h"
#import "TTRecommendUserCollectionViewDelegate-Protocol.h"

@class ExploreActionButton, ExploreArticleMovieViewDelegate, ExploreItemActionManager, ExploreOrderedData, ExploreOriginalData, FriendDataManager, NSDictionary, NSString, SSActivityView, SSThemedButton, SSThemedImageView, SSThemedLabel, SSThemedView, TTActionSheetController, TTActivityShareManager, TTAlphaThemedButton, TTArticleCellEntityWordView, TTArticlePicView, TTAsyncCornerImageView, TTFollowThemeButton, TTHighlightedLabel, TTRecommendUserCollectionViewWrapper, TTUGCAttributedLabel, TTVideoEmbededAdButton, TTlayoutLoopInnerPicView;

@interface TTLayOutCellViewBase : ExploreCellViewBase <TTRecommendUserCollectionViewDelegate, TTLabelTappingDelegate, SSActivityViewDelegate, TTDislikePopViewDelegate>
{
    ...
    TTUGCAttributedLabel *_commentAttrLabel;
    ...
    TTlayoutLoopInnerPicView *_adInnerLoopPicView;
    ...
    SSThemedButton *_foldRecommendButton;
...
@property(nonatomic) _Bool reuseinit; // @synthesize reuseinit=_reuseinit;
...
@property(retain, nonatomic) SSThemedButton *foldRecommendButton; // @synthesize foldRecommendButton=_foldRecommendButton;
...
@property(retain, nonatomic) TTlayoutLoopInnerPicView *adInnerLoopPicView; // @synthesize adInnerLoopPicView=_adInnerLoopPicView;
...
@property(retain, nonatomic) TTUGCAttributedLabel *commentAttrLabel; // @synthesize commentAttrLabel=_commentAttrLabel;
...
- (void)handleExpandStateChange:(_Bool)arg1;
...
- (void)updateDiggCount:(_Bool)arg1;
- (void)digButtonAnimationWith:(id)arg1;
- (void)undoDigWithButton:(id)arg1;
...
@property(nonatomic) _Bool followRecommendEnableStatus; // @dynamic followRecommendEnableStatus;
