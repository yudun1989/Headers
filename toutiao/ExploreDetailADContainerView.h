...
- (void).cxx_destruct;
- (void)updateAutoPlayStatusInADView:(id)arg1;
- (void)tryAutoPlayInVideoADView:(id)arg1;
...
- (void)detailBaseADView:(id)arg1 playInDetailWithModel:(id)arg2 withProcess:(double)arg3;
