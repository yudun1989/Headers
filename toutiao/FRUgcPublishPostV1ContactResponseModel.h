...
@class FRPublishPostSearchUserContactStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcPublishPostV1ContactResponseModel : TTResponseModel
{
    ...
    FRPublishPostSearchUserContactStructModel *_data;
}

@property(retain, nonatomic) FRPublishPostSearchUserContactStructModel *data; // @synthesize data=_data;
