...
@class FRRedpacketOpenResultStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcActivityVideoIntroRedpackV1OpenResponseModel : TTResponseModel
{
    ...
    FRRedpacketOpenResultStructModel *_data;
}

@property(retain, nonatomic) FRRedpacketOpenResultStructModel *data; // @synthesize data=_data;
