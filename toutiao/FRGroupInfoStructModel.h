...
@class FRCommentStructModel, FRImageUrlStructModel, FRMediaInfoStructModel, FRMessageListUserInfoStructModel, NSArray, NSNumber, NSString;
@protocol FRActionStructModel><Optional, FRImageUrlStructModel><Optional, Optional;
