...
@class ExploreOrderedData, NSDate, NSMutableData, NSString, SSJSBridgeWebView, SSThemedLabel, SSThemedView, UIView, WapData;
...
- (void)receiveRedpacketCloseNotification:(id)arg1;
