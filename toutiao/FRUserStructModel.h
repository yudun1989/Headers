...
@class FRUserRoleStructModel, NSArray, NSNumber, NSString;
@protocol FRUserIconStructModel><Optional, FRUserRoleStructModel><Optional, Optional;
...
@interface FRUserStructModel : JSONModel
{
    ...
    NSNumber<Optional> *_followers_count;
    NSNumber<Optional> *_followings_count;
...
@property(retain, nonatomic) NSNumber<Optional> *followings_count; // @synthesize followings_count=_followings_count;
@property(retain, nonatomic) NSNumber<Optional> *followers_count; // @synthesize followers_count=_followers_count;
