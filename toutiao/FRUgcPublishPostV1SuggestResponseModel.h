...
@class FRPublishPostSearchUserSuggestStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcPublishPostV1SuggestResponseModel : TTResponseModel
{
    ...
    FRPublishPostSearchUserSuggestStructModel *_data;
}

@property(retain, nonatomic) FRPublishPostSearchUserSuggestStructModel *data; // @synthesize data=_data;
