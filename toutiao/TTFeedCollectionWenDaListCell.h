...
#import "WDCategoryMainListViewDelegate-Protocol.h"

@class NSString, TTCategory, WDCategoryMainListView;

@interface TTFeedCollectionWenDaListCell : TTFeedCollectionCell <WDCategoryMainListViewDelegate>
{
    WDCategoryMainListView *_listView;
    TTCategory *_category;
}

@property(retain, nonatomic) TTCategory *category; // @synthesize category=_category;
@property(retain, nonatomic) WDCategoryMainListView *listView; // @synthesize listView=_listView;
- (void).cxx_destruct;
