...
@interface FRPublishPostSearchUserContactStructModel : JSONModel
{
    NSNumber *_offset;
    long long _has_more;
    NSArray<FRPublishPostSearchUserStructModel><Optional> *_recently;
...
@property(retain, nonatomic) NSArray<FRPublishPostSearchUserStructModel><Optional> *recently; // @synthesize recently=_recently;
