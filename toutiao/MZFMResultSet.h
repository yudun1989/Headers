...
@class MZFMDatabase, MZFMStatement, NSMutableDictionary, NSString;

@interface MZFMResultSet : NSObject
{
    MZFMDatabase *_parentDB;
    MZFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) MZFMStatement *statement; // @synthesize statement=_statement;
