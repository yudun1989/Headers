...
#import "TTEditUserProfileViewControllerDelegate-Protocol.h"
#import "UIActionSheetDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSObject, NSString, SSNavigationBar, SSThemedButton, SSThemedLabel, SSThemedTableView, SettingPushCell, SettingSwitch, TTIndicatorView, UITapGestureRecognizer, UIView;
@protocol SettingViewDelegate;

@interface SettingView : SSViewBase <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, TTEditUserProfileViewControllerDelegate, TTAccountMulticastProtocol>
{
    double _fileSize;
    ...
    _Bool _shouldShowNightShiftSetting;
    _Bool _shouldShowADRegisterEntrance;
    ...
    SettingSwitch *_nightShiftSwitch;
...
@property(retain, nonatomic) SettingSwitch *nightShiftSwitch; // @synthesize nightShiftSwitch=_nightShiftSwitch;
...
- (void)nightShiftSwitchChange:(id)arg1;
