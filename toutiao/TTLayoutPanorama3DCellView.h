...
@class TTArticlePanorama3DView;

@interface TTLayoutPanorama3DCellView : TTLayOutCellViewBase
{
    TTArticlePanorama3DView *_panoramaView;
}

+ (double)heightForData:(id)arg1 cellWidth:(double)arg2 listType:(unsigned long long)arg3;
@property(retain, nonatomic) TTArticlePanorama3DView *panoramaView; // @synthesize panoramaView=_panoramaView;
- (void).cxx_destruct;
- (void)resumeDisplay;
