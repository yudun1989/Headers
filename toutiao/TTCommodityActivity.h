...
@class NSString, TTCommodityContentItem, UIViewController;

@interface TTCommodityActivity : NSObject <TTActivityProtocol>
{
    TTCommodityContentItem *_contentItem;
}

+ (void)load;
@property(retain, nonatomic) TTCommodityContentItem *contentItem; // @synthesize contentItem=_contentItem;
- (void).cxx_destruct;
