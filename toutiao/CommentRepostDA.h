...
@interface CommentRepostDA : TTDataAdapter
{
...
- (unsigned long long)originMaxLines:(id)arg1;
- (unsigned long long)originDefaultLines:(id)arg1;
- (unsigned long long)maxLines:(id)arg1;
- (unsigned long long)defaultLines:(id)arg1;
