...
@class NSDictionary, NSString, SSThemedLabel, SSThemedView, TTImageView, WDAnswerEntity, WDListCellLayoutModel, WDListCellViewModel, WDWendaListCellActionFooterView, WDWendaListCellExcellentCommentView, WDWendaListCellInputCommentView, WDWendaListCellPureCharacterView, WDWendaListCellUserHeaderView;
@protocol WDListCellActionDelegate, WDListCellLayoutModelBaseProtocol;

@interface WDWendaListLightPureCharacterCell : SSThemedTableViewCell <WDWendaListCellUserHeaderViewDelegate, WDWendaListCellActionFooterViewDelegate, WDWendaListCellInputCommentViewDelegate, WDListCellBaseProtocol>
{
