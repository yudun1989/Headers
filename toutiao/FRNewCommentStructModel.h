...
@class FRNewCommentQutoedStructModel, NSArray, NSNumber, NSString;
@protocol FRNewCommentReplyStructModel><Optional, Optional;
...
@interface FRNewCommentStructModel : JSONModel
{
    ...
    NSNumber<Optional> *_bind_mobile;
...
@property(retain, nonatomic) NSNumber<Optional> *bind_mobile; // @synthesize bind_mobile=_bind_mobile;
