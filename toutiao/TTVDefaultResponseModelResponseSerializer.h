...
#import "TTVDefaultJSONResponseSerializer.h"

#import "TTResponseModelResponseSerializerProtocol-Protocol.h"

@class NSString;

@interface TTVDefaultResponseModelResponseSerializer : TTVDefaultJSONResponseSerializer <TTResponseModelResponseSerializerProtocol>
{
}
