...
@class FRQRCodeLinkInfoStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcThreadLinkV1ConvertResponseModel : TTResponseModel
{
    ...
    FRQRCodeLinkInfoStructModel *_url_info;
}

@property(retain, nonatomic) FRQRCodeLinkInfoStructModel *url_info; // @synthesize url_info=_url_info;
