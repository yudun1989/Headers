...
@class NSString, TTBuryContentItem, UIViewController;

@interface TTBuryActivity : NSObject <TTActivityProtocol, TTActivityPanelActivityProtocol>
{
    TTBuryContentItem *_contentItem;
}

+ (void)load;
@property(retain, nonatomic) TTBuryContentItem *contentItem; // @synthesize contentItem=_contentItem;
- (void).cxx_destruct;
