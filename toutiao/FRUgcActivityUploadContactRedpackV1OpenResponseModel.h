...
@class FRContactsRedpacketOpenResultStructModel, NSNumber, NSString;
@protocol Optional;
...
@interface FRUgcActivityUploadContactRedpackV1OpenResponseModel : TTResponseModel
{
    ...
    FRContactsRedpacketOpenResultStructModel *_data;
}

@property(retain, nonatomic) FRContactsRedpacketOpenResultStructModel *data; // @synthesize data=_data;
