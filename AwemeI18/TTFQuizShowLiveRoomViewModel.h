...
@class CADisplayLink, NSArray, NSMutableDictionary, NSMutableSet, NSString, TTFActivityConfigStruct, TTFAnswerHistory, TTFAuthStruct, TTFCeremonyStruct, TTFCurrencyInfo, TTFFetchLiveInfoTrace, TTFGeneralControlStruct, TTFIndexTrace, TTFLastAnswerInfo, TTFQuestionAnswerUnit, TTFUserStruct, TTFVideoPlayInfo;
...
+ (id)formattedStringWithMyBonus:(long long)arg1 currency:(id)arg2;
+ (id)formattedStringWithAllBonus:(long long)arg1 currency:(id)arg2;
...
@property(nonatomic) _Bool isLoadedIndexInfo; // @synthesize isLoadedIndexInfo=_isLoadedIndexInfo;
...
- (void)recordQuestionAnswerUserCount;
