...
@class HTSMediaMixPlayer, HTSVideoData, HTSVideoDataClipRange, IESMediaTranscoder, NSMutableArray, NSString, NSTimer;
@protocol OS_dispatch_queue;

@interface IESMMAVPlayer : NSObject <HTSMediaMixPlayerDelegate>
{
