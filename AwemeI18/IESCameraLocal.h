...
@class HTSCameraConfiguration, HTSCameraKit, HTSGLCropFilter, HTSGLFilter, HTSGLFilterInput, HTSGLFilterNewEffect, HTSGLPreview, HTSImageLookupFilter, HTSMediaMixPlayer, HTSRawDataOutputRender, HTSVideoData, IESCameraWriter, IESEffectSDKParser, NSMutableArray, NSString, NSTimer, UIButton;
...
@interface IESCameraLocal : IESCamera <HTSMediaMixPlayerDelegate, HTSGLFilterEffectDelegate>
{
    ...
    HTSImageLookupFilter *_imageFilter;
    IESEffectSDKParser *_filterParser;
...
@property(nonatomic) _Bool hasEffect; // @synthesize hasEffect=_hasEffect;
@property(nonatomic) _Bool hasReshape; // @synthesize hasReshape=_hasReshape;
@property(nonatomic) _Bool hasBeautify; // @synthesize hasBeautify=_hasBeautify;
@property(retain, nonatomic) IESEffectSDKParser *filterParser; // @synthesize filterParser=_filterParser;
@property(retain, nonatomic) HTSImageLookupFilter *imageFilter; // @synthesize imageFilter=_imageFilter;
...
- (_Bool)forceRecordAudio;
- (void)setDisableMotionDectection:(_Bool)arg1;
- (_Bool)disableMotionDectection;
...
- (struct CGRect)cropRegionOutputSizeForVideoSize:(struct CGSize)arg1 andVideoSize:(struct CGSize)arg2;
- (struct CGRect)makeCropRegion:(struct CGSize)arg1 andCropSize:(struct CGSize)arg2;
...
- (void)changeOutputSizeForCurrSessionPreset:(struct CGSize)arg1;
