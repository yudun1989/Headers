...
@interface AWEStoryRecorderController : UIViewController <AWELiveAnchorStartLiveControllerDelegate, AWELiveEntranceToolViewDelegate, IESCameraDelegate, AWECustomTransitionDelegate, AWEStoryPublishControllerDelegate, AWEStoryRecorderProgressViewDelegate, BTDRouterViewControllerProtocol, AWEStoryFilterViewControllerDelegate>
{
