...
+ (unsigned long long)btd_maxSocketBufferSize;
+ (unsigned long long)btd_userMemory;
+ (unsigned long long)btd_totalMemory;
+ (unsigned long long)btd_busFrequency;
+ (unsigned long long)btd_cpuFrequency;
