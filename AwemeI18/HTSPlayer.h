...
@class AVAsset, AVMutableVideoComposition, HTSFGDrawFilter, HTSGLPicture, HTSGLSpherePanoramaFilter, HTSMediaExporter, HTSMediaMixPlayer, HTSMoviePlayer, HTSVideoData, IESEffectSDKParser, IESMediaTranscoder, IESVideoProcessBase, NSMutableArray, NSString, NSTimer;
...
@interface HTSPlayer : NSObject <HTSMediaMixPlayerDelegate, HTSMoviePlayerDelegate, HTSMediaExportable>
{
    ...
    unsigned long long _curEffectType;
...
+ (void)getImageWithAsset:(id)arg1 videoComposition:(id)arg2 atTime:(double)arg3 preferredSize:(struct CGSize)arg4 usingFilterEffect:(unsigned long long)arg5 filterImagePath:(id)arg6 filterImageType:(unsigned long long)arg7 compeletion:(CDUnknownBlockType)arg8;
...
@property(nonatomic) __weak HTSFGDrawFilter *fgDrawFilter; // @synthesize fgDrawFilter=_fgDrawFilter;
@property(nonatomic) _Bool needResetFGDrawFilter; // @synthesize needResetFGDrawFilter=_needResetFGDrawFilter;
...
@property(retain, nonatomic) NSString *curFilterPath; // @synthesize curFilterPath=_curFilterPath;
...
@property(readonly, nonatomic) unsigned long long curEffectType; // @synthesize curEffectType=_curEffectType;
...
- (void)enableFGDrawFilter;
- (void)setBrushEffectBlenderRatio:(float)arg1;
...
- (void)updateForegroundFlag;
- (void)resetPlayerWithError:(id)arg1;
- (void)addAllObserver;
- (id)initWithView:(id)arg1 videoData:(id)arg2 withBlock:(CDUnknownBlockType)arg3 needReverseVideo:(_Bool)arg4 isPanorama:(_Bool)arg5;
- (id)init;
