...
@class AWEFilterModel, AWELiveAnchorBottomView, AWELiveAnchorToolView, AWELiveDiggCollectionViewController, AWELiveFilterTipView, AWELiveFilterViewController, AWELiveRecordViewController, AWELiveSilenceListViewController, AWELiveSwitchFilterTipAnimator, NSString, UISwipeGestureRecognizer, UIViewController;
...
@interface AWELiveAnchorViewController : AWELiveInteractViewController <AWEStickerPickerDelegate, AWELiveFilterViewControllerDelegate, UIGestureRecognizerDelegate, AWELiveRecordViewControllerDelegate, CAAnimationDelegate, AWELiveAnchorViewControllerProtocol>
{
    ...
    _Bool _isDefaultBeauty;
    _Bool _hasShowFinishView;
    _Bool _isEnableEffect;
...
@property(nonatomic) _Bool isEnableEffect; // @synthesize isEnableEffect=_isEnableEffect;
...
@property(nonatomic) _Bool isDefaultBeauty; // @synthesize isDefaultBeauty=_isDefaultBeauty;
...
- (void)updateCaptureFrameRate;
- (void)applyCameraPreviewNeededChange;
