...
@class AVAssetExportSession, AVAssetImageGenerator, AVPlayer, AVPlayerLayer, AWEAnimatedButton, AWEButton, HTSVideoSpeedControl, NSArray, NSString, NSTimer, NSURL, SAVideoRangeSlider, UIButton, UICollectionView, UINavigationController, UIView;
