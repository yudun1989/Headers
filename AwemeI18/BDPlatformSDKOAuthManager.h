...
@class BDPlatformSDKAuthViewController, UIWindow;

@interface BDPlatformSDKOAuthManager : NSObject
{
    UIWindow *_oauthWindow;
    BDPlatformSDKAuthViewController *_authViewController;
    UIWindow *_keyWindow;
}
...
@property(retain, nonatomic) BDPlatformSDKAuthViewController *authViewController; // @synthesize authViewController=_authViewController;
