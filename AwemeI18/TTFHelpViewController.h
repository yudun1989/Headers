...
@class NSMutableArray, TTFShareMessage, TTFantasyAnimationView, TTFantasyLabel;
...
@interface TTFHelpViewController : TTFBaseViewController
{
    ...
    TTFantasyAnimationView *_bgView;
...
@property(retain, nonatomic) TTFantasyAnimationView *bgView; // @synthesize bgView=_bgView;
