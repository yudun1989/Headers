...
@class AWECommentModel, CAShapeLayer, NSString, TTTAttributedLabel, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIView;
...
@property(retain, nonatomic) NSString *itemUserID; // @synthesize itemUserID=_itemUserID;
...
- (void)configWithComment:(id)arg1 showSettingBtn:(_Bool)arg2 itemUserID:(id)arg3;
