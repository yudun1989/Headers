...
@class AWEAwemeModel, AWEButton, AWEGoodsManager, NSString, UIButton, UICollectionView, UIImageView, UILabel, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;

@interface AWEGoodsCardViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UIGestureRecognizerDelegate, AWETaobaoDelegate, AWEGoodsListViewProtocol>
{
    _Bool _isAnimating;
    _Bool _isShowing;
    UIView *_baseView;
