...
@class AWEFansInfluenceEntranceView, AWENewPublishTableCell, AWETextInputController, AWEVideoPublishInputSuggestionView, AWEVideoPublishNormalTask, HTSPlayer, NSArray, NSString, UIButton, UIImageView, UILabel, UITableView, UITableViewCell, UITextView, UIView;
...
- (void)p_ensured_login_draftClicked;
- (void)p_draftClicked;
