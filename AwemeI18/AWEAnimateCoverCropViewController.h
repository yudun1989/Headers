...
@class AVAsset, AVAssetExportSession, AVAssetImageGenerator, AVPlayer, AVPlayerLayer, NSArray, NSString, NSTimer, NSURL, SAVideoRangeSlider, UICollectionView, UINavigationController, UIView;
@protocol UIGestureRecognizerDelegate;

@interface AWEAnimateCoverCropViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, SAVideoRangeSliderDelegate, UIScrollViewDelegate>
{
