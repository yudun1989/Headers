...
@protocol TTFSwipeViewDataSource, TTFSwipeViewDelegate;

@interface TTFSwipeView : UIView <UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    id <TTFSwipeViewDataSource> _dataSource;
    id <TTFSwipeViewDelegate> _delegate;
...
@property(nonatomic) __weak id <TTFSwipeViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <TTFSwipeViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
