...
@interface AWEVideoEffectChooseViewController : UIViewController <AWEVideoEffectViewDelegate, AWEVideoEffectMixTimeBarDelegate, AWEVideoEffectChooseAnimationProtocol>
{
    _Bool _isPlaying;
    _Bool _hasOperation;
