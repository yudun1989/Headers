...
#import <QQMainProject/IQQSMNode-Protocol.h>
...
@property QQMessageModel *msgRef; // @synthesize msgRef=_msgRef;
...
@property(retain) NSArray *subElements; // @synthesize subElements=_subElements;
@property(retain) NSString *elemIndex; // @synthesize elemIndex=_elemIndex;
@property(retain) NSString *innerText; // @synthesize innerText=_innerText;
