...
- (int)SendPbSpriteActionMsgToUin:(unsigned long long)arg1 SpriteInfo:(id)arg2 RoutingHead:(struct RoutingHead *)arg3 pkgNum:(BOOL)arg4 pkgIndex:(BOOL)arg5 divSeq:(short)arg6 msgSeq:(unsigned int)arg7 msgRandom:(unsigned int)arg8 shareAppInfo:(id)arg9 SendingModel:(id)arg10 message:(id)arg11;
...
- (MsgBody_ba4fc016 *)GetSpriteActionMsg:(id)arg1 message:(id)arg2;
