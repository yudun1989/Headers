...
@interface QZUploadPacket : NSObject
{
    ...
    long long _retryCountForCurrentIp;
    ...
    NSMutableArray *_connectIpList;
    NSString *_preUploadId;
}

@property(retain, nonatomic) NSString *preUploadId; // @synthesize preUploadId=_preUploadId;
@property(retain, nonatomic) NSMutableArray *connectIpList; // @synthesize connectIpList=_connectIpList;
...
@property(nonatomic) long long retryCountForCurrentIp; // @synthesize retryCountForCurrentIp=_retryCountForCurrentIp;
