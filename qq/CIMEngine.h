...
@protocol CIMAdSvrEngineDelegate, CIMBaseEngineDelegate, CIMCardInfoEngineDelegate, CIMEngineDelegate, CIMFileStorageSvcListDelegate, CIMFriendsSvrEngineDelegate, CIMGetAPPPluginInfoDelegate, CIMGetCacaRespDelegate, CIMLbsSvrEngineDelegate, CIMMGroupEngineDelegate, CIMMsgSvrEngineDelegate, CIMOfflineFileEngineDelegate, CIMOidbSvrEngineDelegate, CIMProfileSvrEngineDelgate, CIMPushSvrEngineDelegate, CIMQZoneSvrEngineDelegate, CIMStreamMsgEngineDelegate, CIMUnkownSvrEngineDelegate, CIMUserSvrEngineDelegate;
