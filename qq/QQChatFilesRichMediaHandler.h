...
@class NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, QQEmptyView, QQLodingMoreFooterView, QQMutipleImageHandler, UICollectionView, UIPanGestureRecognizer;

@interface QQChatFilesRichMediaHandler : QQChatFilesBaseHandler <UIActionSheetDelegate, QQMutipleImageHandlerDelegate, UIAlertViewDelegate, QQFriendSelectedViewControllerDelegate, QQSVOriginalCellDelegete, DBAsyncCallbackProtocol, UICollectionViewDataSource, PhotoBrowserViewControllerDelegate, UICollectionViewDelegateFlowLayout>
{
