...
@class CharmInfoModel, ClearFriendsModel, CommonCardModel, NSArray, NSData, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, OGTConfigModel, OGTConfigTaskModel, QQActivateFriendsModel, QQCityWeatherInfo, QQProfileModel, RichStateModel, TeleEntryModel;

@protocol IQSFileStorageEngine <NSObject>
- (void)asyncSaveQQAVTerminalInfo:(NSArray *)arg1 forUin:(long long)arg2;
- (NSArray *)loadQQAVTerminalInfo:(long long)arg1;
...
- (void)saveData:(NSData *)arg1 forUin:(long long)arg2 withFileName:(NSString *)arg3 isSync:(_Bool)arg4;
- (void)saveData:(NSData *)arg1 forUin:(long long)arg2 withFileName:(NSString *)arg3;
- (NSData *)loadDataForUin:(long long)arg1 withFileName:(NSString *)arg2;
