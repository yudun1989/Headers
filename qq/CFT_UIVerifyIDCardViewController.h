...
@interface CFT_UIVerifyIDCardViewController : CFT_UICustomNaviBarViewController <RegionPickerDelegate, UIAlertViewDelegate, UserSummarySelectOccupationViewControllerDelegate, UITextFieldDelegate>
{
...
- (void)otherRealNameChannelClick;
- (id)setupNextSection;
- (id)setupProcessionSection;
- (id)setupAddressSection;
- (id)setupIDSection;
- (id)getRealNameChannelUrl;
