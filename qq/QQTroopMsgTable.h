...
- (id)getMsgExistFromDates:(id)arg1 toDates:(id)arg2;
- (_Bool)getMsgExistFromDate:(long long)arg1 toDate:(long long)arg2;
- (id)getFirstMsgFromDate:(long long)arg1 toDate:(long long)arg2;
- (id)getEarliestMessageDate;
...
- (id)groupMessageAscWithCount:(unsigned long long)arg1 index:(unsigned long long)arg2;
- (id)groupMessageAscWithPagesize:(unsigned long long)arg1 page:(unsigned long long)arg2;
- (id)groupMessageDescWithMemUins:(id)arg1 typeArray:(id)arg2 pagesize:(unsigned long long)arg3 page:(unsigned long long)arg4;
