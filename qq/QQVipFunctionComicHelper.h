...
- (void)getPicInfoArrayAndModel:(id)arg1 sectionIndex:(unsigned long long)arg2 withComicID:(id)arg3 withCompleteBlock:(CDUnknownBlockType)arg4 usingSimpleComicInfo:(_Bool)arg5;
- (void)getPicInfoArrayAndModel:(id)arg1 withComicID:(id)arg2 withCompleteBlock:(CDUnknownBlockType)arg3;
- (void)getSimplePicInfoArrayAndModel:(id)arg1 withComicID:(id)arg2 withCompleteBlock:(CDUnknownBlockType)arg3;
