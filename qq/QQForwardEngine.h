...
#import <QQMainProject/QRCodeDecodeBizDelegate-Protocol.h>
...
#import <QQMainProject/UniFileTransEngineObserver-Protocol.h>
...
- (void)onReceiveRemoteMsg;
- (void)richMediaPickerController:(id)arg1 didFinishPickingMediaWithInfo:(id)arg2;
- (void)showPTVPickerView;
- (void)showPTVPickerView:(id)arg1 withCategoryID:(id)arg2 withItemID:(id)arg3;
- (_Bool)CheckPhoneCall;
...
- (void)ActionOpenNearbyVideoChat:(id)arg1;
...
- (void)gameBindingGroupListViewCtrlFailFun:(id)arg1;
...
- (void)ActionOpenGLiveWeb:(id)arg1;
- (void)ActionOpenGLiveRoom:(id)arg1;
- (void)ActionOpenNowRoom:(id)arg1;
- (void)ActionOpenShortVideoRecord:(id)arg1;
- (void)ActionPlayNowMedia:(id)arg1;
- (id)getTopViewController:(id)arg1;
- (void)ActionGoToGroupOpenApp:(id)arg1;
- (void)ActionGotoQWerewolfHomePage:(id)arg1;
...
- (_Bool)shouldeJumpStoryPathMainPage:(id)arg1;
...
- (void)ActionOpenQStoryOpenSquareInternal:(id)arg1;
- (void)ActionOpenQStoryOpenSquare:(id)arg1;
- (void)ActionOpenQStoryOpenTagInternal:(id)arg1;
- (void)ActionOpenQStoryOpenTag:(id)arg1;
...
- (void)processActionVideoChatCRM:(id)arg1;
...
- (void)dismissShareUI;
- (id)createShareArkMsg:(id)arg1 accType:(int)arg2 groupCode:(id)arg3 compatibleText:(id)arg4 content:(id)arg5 appShareID:(unsigned int)arg6;
