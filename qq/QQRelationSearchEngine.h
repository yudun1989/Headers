...
@class NSMutableArray, NSString, QQRelationSearchUICompositor, UISearchDisplayController;
@protocol OS_dispatch_queue, QQSearchResultClickResponding;
