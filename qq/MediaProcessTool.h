...
+ (void)processFilterAndDoodle:(id)arg1 withType:(int)arg2 withMediaType:(unsigned long long)arg3 withOverlay:(id)arg4 withSubtitle:(id)arg5 withFilter:(id)arg6 isSilence:(_Bool)arg7 outputVideoSettings:(id)arg8 outputAudioSettings:(id)arg9 outputPath:(id)arg10 withCompletionHandler:(CDUnknownBlockType)arg11;
