...
#import <QQMainProject/SpriteShareDelegate-Protocol.h>
...
- (void)p_doGameShareToWXWithScene:(int)arg1;
- (void)doGameShareToWXCricle;
- (void)doGameShareToWXFriend;
- (void)doGameShareToQzone;
- (void)doGameShareToQQ;
- (id)strReportByShareType;
