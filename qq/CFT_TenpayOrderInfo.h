...
@interface CFT_TenpayOrderInfo : NSObject
{
    ...
    NSString *_offerid;
    NSMutableDictionary *_promotion_info;
    NSString *_sdk_data;
    NSString *_sdk_channel;
    NSString *_sdk_auth_data;
...
@property(retain, nonatomic) NSString *sdk_auth_data; // @synthesize sdk_auth_data=_sdk_auth_data;
@property(retain, nonatomic) NSString *sdk_channel; // @synthesize sdk_channel=_sdk_channel;
@property(retain, nonatomic) NSString *sdk_data; // @synthesize sdk_data=_sdk_data;
@property(retain, nonatomic) NSMutableDictionary *promotion_info; // @synthesize promotion_info=_promotion_info;
