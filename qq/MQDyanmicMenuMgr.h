...
#import <QQMainProject/QQPublicAccountDataMgrProtocol-Protocol.h>
#import <QQMainProject/SelectLocationDelegate-Protocol.h>

@class NSMutableArray, NSMutableDictionary, NSString;
@protocol MQDyanmicMenuDelegate;

@interface MQDyanmicMenuMgr : NSObject <QQPublicAccountDataMgrProtocol, ARQRManagerDelegate, SelectLocationDelegate>
{
