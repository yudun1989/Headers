...
@class NSArray, NSMutableArray, NSString, UIButton, UIImageView, UILabel, UIScrollView, UIView, UIWindow;
@protocol QUIActionSheetDelegate;
...
- (void)hideTheRedDot:(long long)arg1 isHidden:(_Bool)arg2;
