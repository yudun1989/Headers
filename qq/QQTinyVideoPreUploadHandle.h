...
#import <QQMainProject/SVideoSegUploadDelegate-Protocol.h>
...
@interface QQTinyVideoPreUploadHandle : NSObject <SVideoSegUploadDelegate>
{
    ...
    unsigned long long _specialVideoType;
}

@property(nonatomic) unsigned long long specialVideoType; // @synthesize specialVideoType=_specialVideoType;
