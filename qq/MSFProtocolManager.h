...
+ (id)GetInstance;
@property(nonatomic) _Bool launchedByWatch; // @synthesize launchedByWatch=_launchedByWatch;
...
- (void)batchAddGroupMemberWithUins:(id)arg1 groupUin:(unsigned long long)arg2 sourceID:(unsigned int)arg3 subSourceID:(unsigned int)arg4 verifyMsg:(id)arg5;
