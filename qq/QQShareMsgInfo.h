...
@interface QQShareMsgInfo : NSObject
{
    ...
    NSString *_arkData;
    int _xo;
    int _extensionShareType;
    int _extensionFileSubType;
    NSString *_richMsgPreActionUrl;
}

@property(retain, nonatomic) NSString *arkData; // @synthesize arkData=_arkData;
@property(nonatomic) int extensionFileSubType; // @synthesize extensionFileSubType=_extensionFileSubType;
@property(nonatomic) int extensionShareType; // @synthesize extensionShareType=_extensionShareType;
