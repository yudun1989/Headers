...
#import <QQMainProject/QQGroupFaceWallDelegate-Protocol.h>
#import <QQMainProject/QQGroupFaceWallPicTransferManagerDelegate-Protocol.h>
...
@protocol QQGroupFaceWallLogicDelegate;
...
@property(nonatomic) _Bool hideDefaultHeadImage; // @synthesize hideDefaultHeadImage=_hideDefaultHeadImage;
...
@property(nonatomic) __weak QQGroupFaceWallUI *faceWallUI; // @synthesize faceWallUI=_faceWallUI;
