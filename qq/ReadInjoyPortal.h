...
#import <QQMainProject/RDVTabBarControllerDataSource-Protocol.h>
#import <QQMainProject/RDVTabBarControllerDelegate-Protocol.h>
...
- (void)rotateView:(id)arg1 piTimes:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)isShowMainTabRefreshIcon;
- (void)resetMainTabState;
- (void)mainTabRefreshIconStarLoading;
- (void)hideMainTabRefreshIcon;
- (void)showMainTabRefreshIcon;
- (void)activateMainTabRefreshIcon;
...
- (id)tabWithType:(unsigned long long)arg1 autoCreate:(_Bool)arg2;
