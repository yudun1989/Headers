...
#import <QQMainProject/CameraOutputAbstractLayerDelegate-Protocol.h>

@class AVAssetReader, AVAssetReaderTrackOutput, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVPlayer, AVURLAsset, CIContext, CameraOutputAbstractLayer, EAGLContext, GLKViewWithBounds, NSMutableArray, NSString, NSTimer;
@protocol MultipleVideoRecorderControllerDelegate, OS_dispatch_queue, OS_dispatch_source;
