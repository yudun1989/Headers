...
@protocol ICacaDiscussGroupUpdateResult, IDiscussGroupManageDelegate;
...
- (void)asyncInsertDiscussLocalMember:(long long)arg1 insertUin:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (id)findDiscussMember:(unsigned long long)arg1 memberUin:(unsigned long long)arg2;
...
- (id)cachedDiscussMemberList:(unsigned long long)arg1;
...
- (void)changeMemberRemarkName:(unsigned long long)arg1 memberUin:(unsigned long long)arg2 ramarkName:(id)arg3;
...
- (void)changeDiscussGroups:(id)arg1;
...
- (void)reportRdm0x58aStatus:(unsigned long long)arg1 otherCount:(unsigned long long)arg2;
