...
#import <QQMainProject/QZTXVideoSDKDelegate-Protocol.h>
...
@interface QZPhotoVideoDownloader : NSObject <QZTXVideoSDKDelegate, QUIAlertViewDelegate>
{
    ...
    _Bool _ignoreSave;
    NSMutableDictionary *_downloadFinishBlocks;
}
...
- (_Bool)videoIsExist:(id)arg1 videoUrl:(id)arg2;
- (_Bool)preloadVideoId:(id)arg1 videoUrl:(id)arg2 duration:(int)arg3 ignoreSave:(_Bool)arg4 competionBlock:(CDUnknownBlockType)arg5 showToast:(_Bool)arg6;
- (_Bool)preloadVideoId:(id)arg1 videoUrl:(id)arg2 duration:(int)arg3 ignoreSave:(_Bool)arg4 competionBlock:(CDUnknownBlockType)arg5;
