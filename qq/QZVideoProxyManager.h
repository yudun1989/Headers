...
#import <QQMainProject/QZBaseVideoProxyManager.h>
...
- (long long)getClipFileSizeOnDisk:(id)arg1 videoFormat:(id)arg2 videoUrl:(id)arg3 isH265:(_Bool)arg4 withClipNo:(int)arg5;
