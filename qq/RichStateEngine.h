...
#import <QQMainProject/IRichStatusSignatureService-Protocol.h>
#import <QQMainProject/RichStateServiceImplCallback-Protocol.h>

@class NSArray, NSMutableDictionary, NSObject, NSString, RichStateModel, RichStateReqManager, RichStateServiceImpl;
