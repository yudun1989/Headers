...
@interface TBStoryDownloadManager : NSObject <TBBizNetworkLogicDelegate>
{
    ...
    QQLockDictionary *_streamCallBackTree;
}

+ (id)sharedInstance;
@property(retain, nonatomic) QQLockDictionary *streamCallBackTree; // @synthesize streamCallBackTree=_streamCallBackTree;
@property(nonatomic) _Bool isStoryMainPageShow; // @synthesize isStoryMainPageShow=_isStoryMainPageShow;
...
- (void)moveEndFileToFrontWithTempFile:(id)arg1 endFile:(id)arg2 model:(id)arg3 localPath:(id)arg4 endOffset:(unsigned long long)arg5 tempFileSize:(unsigned long long)arg6;
- (void)checkMoovBoxWithTempFile:(id)arg1 localPath:(id)arg2 endFile:(id)arg3 videoModel:(id)arg4;
- (void)checkTempFileSteamingStroyVideoModel:(id)arg1;
...
- (void)downloadPlayingStoryVideosWithDesModel:(id)arg1;
- (CDUnknownBlockType)popSteamCallbackTree:(id)arg1;
- (void)clearSteamCallbackTree;
- (void)pushSteamCallbackTree:(id)arg1 callback:(CDUnknownBlockType)arg2;
- (_Bool)isCurrentlySteaming:(id)arg1;
...
- (void)downloadAIOStoryVideoWithDesModel:(id)arg1 priority:(int)arg2 style:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)preloadFeedsVideoBaiscInfo:(id)arg1;
- (void)initPreloadNotification;
