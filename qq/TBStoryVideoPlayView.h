...
@protocol TBStoryVideoPlayViewDelegate;
...
@property(nonatomic) __weak id <TBStoryVideoPlayViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (id)coverView;
- (void)setCoverImg:(id)arg1;
- (void)removeCoverView;
- (void)videoPlayerDidShow;
- (void)onProgressCallBack;
- (void)startTimerInmainThread;
- (void)startTimer;
- (void)stopTimerInMainThread;
- (void)stopTimer;
