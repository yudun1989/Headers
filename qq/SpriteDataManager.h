...
@property(nonatomic) _Bool needPet; // @synthesize needPet=_needPet;
...
- (_Bool)loadSpriteViewHiddenValue;
...
- (void)saveConfigWithString:(id)arg1 Path:(id)arg2;
