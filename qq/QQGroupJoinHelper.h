...
- (void).cxx_destruct;
- (void)dealloc;
- (void)showAddFriendSendMessageViewControllerWithGroupOpt:(unsigned int)arg1 settingModel:(id)arg2;
- (void)showAddFriendSendMessageViewControllerWithGroupOpt:(unsigned int)arg1;
- (void)_schoolCardRequestFinishIdentityCard:(id)arg1 schoolGourpOpt:(int)arg2 userInfo:(id)arg3;
