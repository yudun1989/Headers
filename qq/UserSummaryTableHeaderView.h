...
#import <QQMainProject/AppOnlineViewDelegate-Protocol.h>
#import <QQMainProject/UserSummaryZanViewDelegate-Protocol.h>

@class APUnreadRedPointView, AppOnlineView, NSMutableArray, NSNumber, NSString, QQAvatarView, QQBubbleTipsView, RichStateModel, RichStateOneLineFastView, RichStateView, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UITapGestureRecognizer, UIView, USZanLoveAnimationView, UserSummaryCardLabel, UserSummaryContainerTips, UserSummaryCoverView, UserSummaryMedalsView, UserSummaryTIMOnlineView, UserSummaryVoiceLabel, UserSummaryZanButton, UserSummaryZanView, ZanButtonContainerView;
@protocol UserSummaryTableHeaderViewDelegate><UserSummaryTableHeaderViewDataSource><QQBannerTipViewDelegate;
...
@interface UserSummaryTableHeaderView : UIControl <UserSummaryZanViewDelegate, AppOnlineViewDelegate>
{
    ...
    UserSummaryTIMOnlineView *_timOnlineView;
...
@property(retain, nonatomic) UIImageView *medalRedPointHint; // @synthesize medalRedPointHint=_medalRedPointHint;
@property(retain, nonatomic) UIButton *medalsCountButton; // @synthesize medalsCountButton=_medalsCountButton;
@property(retain, nonatomic) UserSummaryMedalsView *medalView; // @synthesize medalView=_medalView;
...
- (void)updateTIMTips;
- (void)showTIMOnlineViewWithText:(id)arg1 iconURL:(id)arg2;
- (void)setZanAccessiblilityLabel;
- (void)hideZanView:(_Bool)arg1;
- (void)updateAllData:(id)arg1;
- (void)onCoverViewClicked:(id)arg1;
- (void)onNewGotMedalReportSuccess:(id)arg1;
- (void)updateMedalsCountWithTotalMedalsCount:(long long)arg1;
