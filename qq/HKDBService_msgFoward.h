...
#import <QQMainProject/IHKMultiTableDB-Protocol.h>

@class NSString, QQHonestTalkingMsgTable;

@interface HKDBService_msgFoward : NSObject <IHKMultiTableDB>
{
    QQHonestTalkingMsgTable *_msgTable;
}
