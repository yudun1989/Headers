...
- (id).cxx_construct;
- (void).cxx_destruct;
- (double)getRecallMessageTime;
- (void)setRecallMessageTiem:(double)arg1;
- (id)getRecallMessageContent;
- (void)setRecallMessageContent:(id)arg1;
- (void)setHsSendUin:(unsigned long long)arg1;
- (unsigned long long)hsSendUin;
- (void)setHsBgType:(unsigned int)arg1;
- (unsigned int)hsBgType;
- (void)setHsConfessToUin:(unsigned long long)arg1;
- (unsigned long long)hsConfessToUin;
- (void)setHsConfessNickName:(id)arg1;
- (id)hsConfessNickName;
- (void)setHsIsSysMsg:(_Bool)arg1;
- (_Bool)hsIsSysMsg;
- (void)setHsConfess:(id)arg1;
- (id)hsConfess;
- (void)setHsConfessorSex:(int)arg1;
- (int)hsConfessorSex;
- (void)setHsConfessorUin:(unsigned long long)arg1;
- (unsigned long long)hsConfessorUin;
- (void)setHsTopicId:(int)arg1;
- (int)hsTopicId;
- (void)setHsConfessorNick:(id)arg1;
- (id)hsConfessorNick;
