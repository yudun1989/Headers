...
@class NSDate, NSDictionary, NSMutableArray, NSRecursiveLock, QZJPhotoDailyConfigEventcard, QZScanPhotoOperation;
...
- (id)event:(id)arg1 key:(id)arg2 gpsInfo:(id)arg3 hideArray:(id)arg4;
...
- (id)latestScanDateFromCacheEvents:(id)arg1;
