...
#import <QQMainProject/QQAVCaptureControllerDelegate-Protocol.h>
...
@class NSDictionary, NSMutableArray, NSString, QQMultiImagePickerController, QQStoryLocalMediaModel, QQStoryViewController, QQVideoRecordDurationLabel, TBEditViewContainer, TBMultimediaEditDataReportEngine, TBStoryMultimediaEditView, TBStoryVideoClipViewController, TBStoryVideoPreviewView, TBVideoClipsPreView, TBVideoPerformanceLogger, TBVideoTagInfoBase, UIActivityIndicatorView, UIImage, UIImageView, UILabel, UIView;
@protocol QQVideoCaptureViewControllerDelegate;
...
@interface QQVideoCaptureViewController : QQAVCaptureViewController <TBVideoClipsPreViewDelegate, QQRichMediaPickerDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, TBStoryVideoPreviewViewDelegate, UIGestureRecognizerDelegate, AVAudioPlayerDelegate, UIAlertViewDelegate, TBBizNetworkLogicDelegate, AudioRouteChangeProtocol, TBStoryMusicManagerPlayDelegate, TBStoryVideoClipViewControllerDelegate, TBEditViewContainerDataSource, TBStoryUserGuideDelegate, TBMultimediaEditViewDelegate, UIViewControllerTransitioningDelegate, QQMultiImagePickerControllerDelegate, QQAVCaptureControllerDelegate, CAAnimationDelegate>
{
    ...
    _Bool _isFromVideoTagWeb;
    _Bool _isShowedTagAlert;
    _Bool _authCamera;
    _Bool _authMic;
...
- (_Bool)isBlackImage:(id)arg1;
- (void)asyncCheckFirstBlackFrameOfVideo:(id)arg1 startTime:(double)arg2 endTime:(double)arg3;
...
- (id)initWithVideoTagInfoDic:(id)arg1;
- (id)init;
