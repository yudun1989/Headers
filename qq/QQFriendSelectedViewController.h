...
#import <QQMainProject/QQForwardImageEditHandleDelegate-Protocol.h>
#import <QQMainProject/QQFriendSelectedViewControllerDelegate-Protocol.h>
#import <QQMainProject/QQMutipleImageHandlerDelegate-Protocol.h>
...
#import <QQMainProject/QQThirdAppShareCancelDelegate-Protocol.h>
...
@class FAModel, MarketFaceInfo, NSArray, NSData, NSDate, NSDictionary, NSMutableArray, NSNumber, NSObject, NSString, NSTimer, QQAIOModel, QQAIOSMMessageModel, QQActivateFriendsNotifyMemorialDayModel, QQAlertView, QQArkMsgPreviewDialog, QQAvatarView, QQConnectPluginInfoQuery, QQForwardImageEditHandle, QQForwardMutipleImageHandler, QQHttpClientSession, QQMessageView, QQPreviewImageRetriever, QQRichMediaPickerController, QQRichMsgBizTask, QQRichMsgPreviewDialog, QQShareMsgInfo, QQShareResultDialog, QQStructureMsgUtility, QQStructureMsgWriterBase, QQURLRichMsgHelper, QQWalletPFAFriendsHandler, QUICheckBoxAlertView, UIImage, UIViewController;
@protocol QQFriendSelectedViewControllerDelegate;
...
@interface QQFriendSelectedViewController : QQSearchBaseViewController <QQURLRichMsgHelperDelegate, QUIAlertViewDelegate, UITableViewDataSource, UIAlertViewDelegate, UITableViewDelegate, QQMutipleImageHandlerDelegate, QQSearchResultClickResponding, QQForwardImageEditHandleDelegate, MulMemSelBusiProcessDelegate, QQConnectPluginCheckDelegate, QQFriendSelectedViewControllerDelegate, RichMsgPreviewDialogDelegate, UITextFieldDelegate, QQShareResultDialogDelegate, FriendSelectedChildViewDeletage, QQBizTaskDelegate, QQThirdAppShareCancelDelegate, QQStructureMsgUtilityDelegate>
{
    ...
    QQArkMsgPreviewDialog *_arkMsgPreDlg;
    ...
    _Bool _createInitialGrpForForwarding;
    _Bool _isJSShare;
    int _shareToType;
    NSDate *_startTime;
    NSString *_tailMsg;
    ...
    _Bool _isThirdForwardArk;
    NSString *_thirdShareArkContent;
    QQStructureMsgWriterBase *_writerBase;
...
@property(retain, nonatomic) QQShareMsgInfo *shareMsgInfo; // @synthesize shareMsgInfo=_shareMsgInfo;
@property(retain, nonatomic) QQStructureMsgWriterBase *writerBase; // @synthesize writerBase=_writerBase;
@property(retain, nonatomic) NSString *thirdShareArkContent; // @synthesize thirdShareArkContent=_thirdShareArkContent;
@property(nonatomic) _Bool isThirdForwardArk; // @synthesize isThirdForwardArk=_isThirdForwardArk;
...
@property(nonatomic) _Bool createInitialGrpForForwarding; // @synthesize createInitialGrpForForwarding=_createInitialGrpForForwarding;
...
- (void)actionCreateGroupSuccForShare:(id)arg1;
...
- (void)showPFASuggestionCommentListDlg:(id)arg1 isFromRecommend:(_Bool)arg2;
...
- (void)sendThirdAppShareArkMsg:(id)arg1 msg:(id)arg2;
- (void)sendThirdAppShareMsg:(id)arg1 msg:(id)arg2;
- (_Bool)sendImage:(id)arg1 xmlContent:(id)arg2 msgModel:(out id *)arg3 attachedMsg:(id)arg4;
