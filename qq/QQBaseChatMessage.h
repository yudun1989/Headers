...
@interface QQBaseChatMessage : NSObject <QC2CRoamMessageDelegate, FTSMsgEngineDelegate, QMsgSpliteMergeProtocol>
{
    ...
    struct {
        _Bool isLatestStoryFeedLoaded;
    } _storyFeedInsertInfo;
...
- (void)asynMsgListByInsertingLatestStoryFeedList:(id)arg1;
- (void)processInsertNewestQzoneFeedList:(id)arg1 msgList:(id)arg2;
- (void)processInsertStoryFeedList:(id)arg1 msgList:(id)arg2;
...
- (void)insertAbandenStickGrayTipsTroop:(id)arg1 HostAbandonList:(id)arg2;
- (void)insertAbandenStickGrayTipsC2C:(id)arg1 HostAbandonList:(id)arg2;
