...
#import <QQMainProject/IRichMediaPBTransferResult-Protocol.h>

@class NSMutableArray, NSString;

@interface PBLongMsgManager : NSObject <IRichMediaPBTransferResult>
{
...
- (void)onDownloadLongMsgFailed:(id)arg1 error:(id)arg2;
- (void)onDownloadLongMsgSuccess:(id)arg1 receivedData:(id)arg2;
- (void)notifyDownloadReqResult:(_Bool)arg1 SsoSeq:(int)arg2 Err:(id)arg3 DownloadUrl:(id)arg4;
- (void)downloadLongMsgByRequestSSOUrl:(id)arg1;
- (void)downloadHttpLongMsgWithTask:(id)arg1;
