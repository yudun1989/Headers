...
@class EAGLContext, QAVFilter, QQRichGLProgramCustom, QQRichGLProgramFaceOff, QQRichGLProgramMeshDistortion, QQRichGLProgramPortraitSmoothReal, QQRichPTVGLProgramCommon, QQRichPTVGLProgramGesture;
...
- (void)textureY:(char *)arg1 widthType:(int)arg2 heightType:(int)arg3;
- (void)textureUV:(char *)arg1 widthType:(int)arg2 heightType:(int)arg3;
