...
#import <QQMainProject/IGroupAudioChatService-Protocol.h>
...
@interface GroupAudioChatService : NSObject <CallkitDelegate, QUIAlertPlusViewDelegate, QUIAlertViewDelegate, IGroupAudioChatService, IEngineDispatchDelegate, UIAccelerometerDelegate, AVHttpEngineDelegate, IQQDBOperationBase>
{
    ...
    NSMutableDictionary *_beginVideoChatDict;
    ...
    NSMutableArray *_gliveGroupVideoMemberList;
    long long _groupAudioEnterReqState;
}

+ (id)GetInstance;
@property(nonatomic) long long groupAudioEnterReqState; // @synthesize groupAudioEnterReqState=_groupAudioEnterReqState;
@property(copy, nonatomic) NSMutableArray *gliveGroupVideoMemberList; // @synthesize gliveGroupVideoMemberList=_gliveGroupVideoMemberList;
...
@property(nonatomic) int chattingBusinessSubType; // @synthesize chattingBusinessSubType=_chattingBusinessSubType;
...
- (int)EnterOldGroupAudioChat:(int)arg1 withRelationType:(int)arg2 withRelationID:(unsigned long long)arg3 withAVType:(int)arg4 withAVSubType:(int)arg5 withEntrance:(int)arg6 withMembers:(id)arg7 pstnConfId:(int)arg8;
- (void)EnterNewGroupLive:(unsigned long long)arg1 withEntranceType:(int)arg2;
