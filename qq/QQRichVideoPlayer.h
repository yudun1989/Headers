...
@class AVPlayer, AVPlayerItem, AVPlayerLayer, NSError, NSOperationQueue;
@protocol QQRichViewPlayerDelegte;
...
@property __weak id <QQRichViewPlayerDelegte> delegate; // @synthesize delegate=_delegate;
