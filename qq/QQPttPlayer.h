...
#import <QQMainProject/QQVoiceRouteChangeBtnDelegate-Protocol.h>

@class CMAccelerometerData, NSMutableSet, NSString, QQAIOMsgModel, QQPTTPlaybackVolumeMonitor, QQVoiceRouteChangeBtn;
@protocol IPttPlayerInterface, QQPttPlayerDelegate;
