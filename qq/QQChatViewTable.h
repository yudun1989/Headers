...
#import <QQMainProject/QQAIOCellDelegate-Protocol.h>
...
@protocol QQChatViewTableDelegate;
...
- (void).cxx_destruct;
- (void)showVASAvatarViewDisplayCell:(id)arg1;
...
- (void)didSelectFamilySchoolKeyWord:(id)arg1;
