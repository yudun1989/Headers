...
#import <QQMainProject/UIRedGiftCellDelegate-Protocol.h>
#import <QQMainProject/UITableViewDataSource-Protocol.h>
#import <QQMainProject/UITableViewDelegate-Protocol.h>

@class CAShapeLayer, CFT_TPRedGiftManager, CFT_UIPullTableView, NSMutableArray, NSMutableDictionary, NSString, QQAvatarView, QQWebViewController, UIButton, UIImage, UIImageView, UILabel, UIView;
...
@interface CFT_UIRedGiftDetailViewController : CFT_UICustomNaviBarViewController <UITableViewDelegate, UITableViewDataSource, UIPullTableViewDelegate, UIRedGiftCellDelegate, CAAnimationDelegate>
{
    ...
    QQWebViewController *_adBannerVC;
    _Bool _isFromRecord;
    _Bool _graped;
...
@property(nonatomic) int redStatus; // @synthesize redStatus=_redStatus;
@property(nonatomic) _Bool isShowAD; // @synthesize isShowAD=_isShowAD;
@property(retain, nonatomic) NSString *adWebviewUrl; // @synthesize adWebviewUrl=_adWebviewUrl;
...
- (void)dealloc;
- (void)adReloadTableviewFootview;
