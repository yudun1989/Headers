...
@class NSArray, NSMutableArray, NSMutableSet, NSMutableString, NSString, NSTimer;
...
@property(readonly, retain) NSObject *pluginLock; // @synthesize pluginLock=_pluginLock;
