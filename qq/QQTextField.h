...
@property(nonatomic) _Bool isSGOInput; // @synthesize isSGOInput=_isSGOInput;
@property(nonatomic) _Bool isTribeDetailInput; // @synthesize isTribeDetailInput=_isTribeDetailInput;
