...
#import <QQMainProject/IHKDBService_MultiTable-Protocol.h>

@class NSString, QQLockDictionary;

@interface QQHonestTalkingMsgDBService : NSObject <IHKDBService_MultiTable, DBAccountChangedProtocol, DBAsyncCallbackProtocol>
{
...
- (_Bool)batchInsertSendMessages:(id)arg1 checkTime:(_Bool)arg2;
