...
@class NSArray, NSData, NSDictionary, NSString, QZJNsQqradioProtocolAction, QZJNsQqradioProtocolGeoInfo, QZJNsQqradioProtocolLBSInfo, QZJNsQqradioProtocolLiveShowRoomExtendInfo, QZJNsQqradioProtocolOutShare, QZJNsQqradioProtocolPicture, QZJNsQqradioProtocolRecordPlayInfo, QZJNsQqradioProtocolShowInfo, QZJNsQqradioProtocolUser;
...
@property(retain, nonatomic, getter=jce_backgroudMusic, setter=setJce_backgroudMusic:) QZJNsQqradioProtocolShowInfo *jcev2_p_59_o_backgroudMusic; // @dynamic jcev2_p_59_o_backgroudMusic;
...
@property(nonatomic, getter=jce_isShowTopic, setter=setJce_isShowTopic:) _Bool jcev2_p_60_o_isShowTopic; // @dynamic jcev2_p_60_o_isShowTopic;
@property(retain, nonatomic, getter=jce_starPageItem, setter=setJce_starPageItem:) NSArray *jcev2_p_61_o_starPageItem__b0x9i_VOQZJNsQqradioProtocolStarPageItem; // @dynamic jcev2_p_61_o_starPageItem__b0x9i_VOQZJNsQqradioProtocolStarPageItem;
@property(retain, nonatomic, getter=jce_strGdtJson, setter=setJce_strGdtJson:) NSString *jcev2_p_62_o_strGdtJson; // @dynamic jcev2_p_62_o_strGdtJson;
@property(retain, nonatomic, getter=jce_mapExtendInfo, setter=setJce_mapExtendInfo:) NSDictionary *jcev2_p_63_o_mapExtendInfo__b0x9i_M09ONSNumberONSString; // @dynamic jcev2_p_63_o_mapExtendInfo__b0x9i_M09ONSNumberONSString;
