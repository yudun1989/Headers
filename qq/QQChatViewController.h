...
#import <QQMainProject/QQBabyQKeyWordViewDelegate-Protocol.h>
#import <QQMainProject/QQGrayTipsManagerDelegate-Protocol.h>
#import <QQMainProject/QQPttRecorderDelegate-Protocol.h>
#import <QQMainProject/QshipAnimationViewDelegate-Protocol.h>
...
@interface QQChatViewController : QQBaseChatViewController <RichMsgPreviewDialogDelegate, DBAsyncCallbackProtocol, QQGrayTipsManagerDelegate, QQPttRecorderDelegate, ArkBannerTipsDelegate, QQBabyQKeyWordViewDelegate, UIActionSheetDelegate, QshipAnimationViewDelegate, UIAlertViewDelegate, GetTroopMemberProtocol, GetTroopRemarkProtocol>
{
    ...
    _Bool _isTIMOnline;
    _Bool _isTIMAIONavigationBarBgSwitchOn;
    _Bool _isTIMAppearance;
    int currentPage;
    UIView *_sliderView;
...
- (void)setAppOnlineSubtitleIcon:(_Bool)arg1;
...
- (_Bool)isAppOnlineAndSwitchOnForAppType:(int)arg1;
- (void)disableThemeIfNeededForAppType:(int)arg1;
...
- (_Bool)sendPicLightCommentWithEncodeString:(id)arg1 withRichStr:(id)arg2;
...
- (_Bool)businessP2PAVViewDidLoad;
...
- (_Bool)businessOneWayViewDidLoad;
