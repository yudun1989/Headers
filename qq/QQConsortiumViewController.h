...
@class NSMutableArray, NSMutableDictionary, NSString, NSTimer, QQAVChatControlBar, QQAVNoticeView, QQAVTipsView, QQAVWebViewController, QQCollectionView, QQConsortiumAddFriendView, QQConsortiumInfo, QQWebShareActionSheet, QUIAlertView, TUDotIndicator, UIImage, UILabel, UIView;
...
- (void)autoCloseConsortiumControllerWhenAccpetThirdCall:(id)arg1;
