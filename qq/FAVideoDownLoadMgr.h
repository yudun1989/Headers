...
#import <QQMainProject/ITVVideoDownloadDelegate-Protocol.h>

@class FAVideoTVDownTask, NSMutableArray, NSMutableDictionary, NSString;
@protocol FADelegate, OS_dispatch_queue;
