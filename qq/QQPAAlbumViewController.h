...
#import <QQMainProject/PAPhotoRecommandViewDelegate-Protocol.h>
#import <QQMainProject/PAPhotoViewDelegate-Protocol.h>
...
@class NSIndexPath, NSMutableArray, NSString, PAAlbumTableView, PAPhotoRecommandView, PAPhotoTipView, PAPublicAccountAlbumModel, QQWebShareActionSheet, UIButton, UIView;

@interface QQPAAlbumViewController : QQViewController <UITableViewDataSource, UITableViewDelegate, PAPhotoRecommandViewDelegate, UIViewControllerTransitioningDelegate, ActionSheetDataDelegate, UIGestureRecognizerDelegate, PAPhotoViewDelegate>
{
    _Bool _isInit;
    double _initTime;
