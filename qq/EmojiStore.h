...
@class EmojiStoreUIAdapter, MagicEmojiAddBtn, NSArray, NSMutableArray, NSMutableDictionary, NSNumber, NSString, PriorEmojiManager, QQLockDictionary;
...
@interface EmojiStore : NSObject <IEngineDispatchDelegate, UIAlertViewDelegate>
{
    ...
    _Bool _canSyncMagic;
    _Bool _ipSiteOCSPluginInvoked;
    _Bool _isExistemojiStoreDir;
    int _wifiAutoDownloadStatus;
    int _biuWifiAutoDownloadStatus;
    ...
    NSMutableDictionary *_biuRoamPackages;
    NSMutableArray *_biuRoamEmojiSeqArr;
}

@property(nonatomic) _Bool isExistemojiStoreDir; // @synthesize isExistemojiStoreDir=_isExistemojiStoreDir;
@property(retain, nonatomic) NSMutableArray *biuRoamEmojiSeqArr; // @synthesize biuRoamEmojiSeqArr=_biuRoamEmojiSeqArr;
@property(retain, nonatomic) NSMutableDictionary *biuRoamPackages; // @synthesize biuRoamPackages=_biuRoamPackages;
...
@property(nonatomic) _Bool ipSiteOCSPluginInvoked; // @synthesize ipSiteOCSPluginInvoked=_ipSiteOCSPluginInvoked;
@property(nonatomic) int biuWifiAutoDownloadStatus; // @synthesize biuWifiAutoDownloadStatus=_biuWifiAutoDownloadStatus;
...
- (_Bool)addSelfImage:(id)arg1 withToast:(_Bool)arg2;
...
- (_Bool)canDeletePackageResource:(id)arg1;
...
- (void)responseOnEmojiKey:(struct CPBMessageDecoder *)arg1 ret:(int)arg2 context:(id)arg3;
- (void)requestEmojiKey:(id)arg1 from:(id)arg2;
...
- (_Bool)requestPackageDowload:(unsigned int)arg1 businessType:(long long)arg2;
- (void)reportEmojiPackagesSequence:(id)arg1;
- (_Bool)requestPackageInfosBeginWithSegment:(int)arg1 context:(id)arg2 businessType:(long long)arg3;
- (_Bool)requestPackageInfosBeginWithSegment:(int)arg1 businessType:(long long)arg2;
...
- (void)showIPSiteView:(unsigned int)arg1;
- (void)requestIpStackInfo:(unsigned int)arg1;
...
- (void)updateMagicIndexWithNum:(unsigned long long)arg1;
...
- (id)getMagicEmojiPackageInfoWithId:(unsigned long long)arg1;
