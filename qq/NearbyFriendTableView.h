...
#import <QQMainProject/NearbyFriendDynamicAvatarDelegate-Protocol.h>
#import <QQMainProject/NearbyInterestTagFooterViewDelegate-Protocol.h>
#import <QQMainProject/UITableViewDataSource-Protocol.h>
#import <QQMainProject/UITableViewDelegate-Protocol.h>

@class CFFootView, EGORefreshTableHeaderView, NSMutableArray, NSMutableDictionary, NSString, NearbyInterestTagFooterView, QQTabWithInPageControl, QQViewController, QQZanTopView, UIView;
@protocol NearbyFriendTableViewDelegate;
...
- (void)receivedInterestTagChangeNotification:(id)arg1;
- (id)getInterestTagSelectWebViewController:(long long)arg1;
