...
+ (id)parseFamilySchoolKeyWordCanSelect:(id)arg1 actionType:(long long)arg2 text:(id)arg3 showText:(id)arg4;
...
+ (void)drawQQEmotionString:(id)arg1 inView:(id)arg2 inRect:(struct CGRect)arg3 withFont:(id)arg4 withLayoutResult:(id)arg5 color:(id)arg6 isShadow:(_Bool)arg7 shadowColor:(id)arg8 shadowOffset:(struct CGSize)arg9 shadowBlur:(double)arg10 animated:(_Bool)arg11 highlightColor:(id)arg12;
...
+ (void)VAS_DrawQQEmotionString:(id)arg1 inView:(id)arg2 inRect:(struct CGRect)arg3 aioTextFont:(id)arg4 withLayoutResult:(id)arg5 color:(id)arg6 isShadow:(_Bool)arg7 shadowColor:(id)arg8 shadowOffset:(struct CGSize)arg9 shadowBlur:(double)arg10 shadowBlurColor:(id)arg11 animated:(_Bool)arg12 highlightColor:(id)arg13;
...
+ (id)layoutQQEmotionString:(id)arg1 maxWidth:(double)arg2 font:(id)arg3 numberOfLines:(long long)arg4;
