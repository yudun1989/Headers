...
#import <QQMainProject/QQCreateGroupDelegate-Protocol.h>
...
@interface GameBindingGroupListViewController : QQSearchBaseViewController <UITableViewDataSource, UITableViewDelegate, QQCreateGroupAuthorityDelegate, QQCreateGroupDelegate, QQAdjustOpenIDDelegate>
{
    ...
    NSString *_gamename;
    SEL _closeBtnClickSelForFail;
}

@property(nonatomic) SEL closeBtnClickSelForFail; // @synthesize closeBtnClickSelForFail=_closeBtnClickSelForFail;
