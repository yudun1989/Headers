...
#import <QQMainProject/QQMessageModel.h>
...
@interface QQRecentMessageModel : QQMessageModel
{
    ...
    NSString *_personalSigText;
    _Bool _isInTopState;
    _Bool _isInServiceFolder;
    _Bool _isCmShowGameOutdate;
    int _setTopStateTime;
    int _currentIndex;
}

@property(nonatomic) _Bool isCmShowGameOutdate; // @synthesize isCmShowGameOutdate=_isCmShowGameOutdate;
...
@property(retain, nonatomic) NSString *personalSigText; // @synthesize personalSigText=_personalSigText;
