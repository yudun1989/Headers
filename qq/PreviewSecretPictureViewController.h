...
#import <QQMainProject/DownloadPreviewImageHandlerDelegate-Protocol.h>
#import <QQMainProject/PreviewSecretPictureViewDelegate-Protocol.h>
...
@protocol PreviewSecretPictureViewControllerDelegate;
