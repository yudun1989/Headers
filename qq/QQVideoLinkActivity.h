...
@protocol QQVideoLinkDelegate;

@interface QQVideoLinkActivity : QQActivity
{
    int _type;
    UIImage *_activityImage;
    NSString *_activityTitle;
    id <QQVideoLinkDelegate> _delegate;
}

@property(nonatomic) id <QQVideoLinkDelegate> delegate; // @synthesize delegate=_delegate;
