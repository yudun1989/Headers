...
@interface TBRspProfileYearNodeList : NSObject <ITBPBParseData>
{
    TBErrorInfo *_error;
    NSArray *_yearNodeList;
}

@property(retain, nonatomic) NSArray *yearNodeList; // @synthesize yearNodeList=_yearNodeList;
