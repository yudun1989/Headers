...
+ (void)rdmEventReportVideoPreloadWithSceneType:(unsigned long long)arg1 triggerCount:(unsigned long long)arg2 cacheHitCount:(unsigned long long)arg3 chacheNotHitCount:(unsigned long long)arg4 preloadHitCount:(unsigned long long)arg5 realPreloadHitCount:(unsigned long long)arg6;
...
+ (void)SendVideoInfoWithArticleId:(id)arg1 videoID:(id)arg2 reportType:(long long)arg3 reCode:(long long)arg4 rowkey:(id)arg5;
+ (id)reportSerialQueue;
