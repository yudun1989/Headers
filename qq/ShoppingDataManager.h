...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, ShoppingAdMsgModel, ShoppingConfigModel;
@protocol OS_dispatch_queue, ShoppingDataManagerDelegate;
...
@interface ShoppingDataManager : NSObject <IEngineDispatchDelegate, DBAccountChangedProtocol, IQQDBOperationBase>
{
    ...
    NSString *_str_task_info;
    NSString *_str_jump_url;
    long long _msgRecevieTime;
    struct CLLocationCoordinate2D _coordinate;
}

+ (void)clearDataWhenDeleteFolder;
+ (id)getInstance;
@property(nonatomic) long long msgRecevieTime; // @synthesize msgRecevieTime=_msgRecevieTime;
@property(retain, nonatomic) NSString *str_jump_url; // @synthesize str_jump_url=_str_jump_url;
@property(retain, nonatomic) NSString *str_task_info; // @synthesize str_task_info=_str_task_info;
