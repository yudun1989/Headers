...
#import <QQMainProject/GroupVideoViewControlDelegate-Protocol.h>
#import <QQMainProject/MemRankInfoBoardDelegate-Protocol.h>
#import <QQMainProject/QQAVGroupTextFieldDelegate-Protocol.h>
#import <QQMainProject/QQGroupAVChatMessageViewDelegate-Protocol.h>

@class CALayer, GroupAudioNeedInfo, GrpVideoMemRankControl, NSDictionary, NSMutableArray, NSString, QQAVGroupTextField, QQAVTipsView, QQCollectionView, QQGroupAVChatMessageView, QQGroupVideoWebView, UIActivityIndicatorView, UIButton, UIImageView, UILabel;
@protocol QQAVGroupVideoControlPanelDelegate;
