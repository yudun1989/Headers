...
@property(readonly, nonatomic) _Bool firstSetExtraState; // @synthesize firstSetExtraState=_firstSetExtraState;
@property(readonly, nonatomic) _Bool firstSetBaseState; // @synthesize firstSetBaseState=_firstSetBaseState;
- (id)description;
