...
@property(nonatomic) _Bool campusEntrance; // @synthesize campusEntrance=_campusEntrance;
@property(copy, nonatomic) NSString *campusClass; // @synthesize campusClass=_campusClass;
@property(copy, nonatomic) NSString *campusRealName; // @synthesize campusRealName=_campusRealName;
@property(copy, nonatomic) NSString *campusCollege; // @synthesize campusCollege=_campusCollege;
@property(copy, nonatomic) NSString *campusSchool; // @synthesize campusSchool=_campusSchool;
