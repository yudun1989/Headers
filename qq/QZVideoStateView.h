...
@class NSString, QZFeedVideoLoadView, QZRichTextLabel, UIButton, UIImageView, UILabel;
...
@interface QZVideoStateView : UIView
{
    ...
    QZRichTextLabel *_hotVideoSummaryView;
...
- (void).cxx_destruct;
- (void)setIsOriginViewHidden:(_Bool)arg1;
