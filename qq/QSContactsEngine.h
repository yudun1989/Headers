...
#import <QQMainProject/QSContactsEngineBase.h>

#import <QQMainProject/IEngineDispatchDelegate-Protocol.h>
#import <QQMainProject/IQSContactsEngine-Protocol.h>

@class NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString;
...
@interface QSContactsEngine : QSContactsEngineBase <IQSContactsEngine, IEngineDispatchDelegate>
{
    ...
    _Bool _hasReadDenyAuth;
    _Bool _isUserDenyAuth;
    _Bool _hasReadAllowAuth;
    _Bool _isUserAllowAuth;
    _Bool _isAuthHookSuccess;
    NSObject *_authLock;
...
- (void)ansyReadUserAllowAuth;
- (_Bool)isUserAllowAuthFromSystem;
- (_Bool)isUserAllowToAccessData;
- (void)ansyReadUserDenyAuth;
- (_Bool)isUserDenyAuthFromSystem;
- (_Bool)isUserDenyToAccessData;
- (void)ansyUpdateUserAuthToCache;
