...
@interface QQTroopMemModel : QQModel
{
    ...
    int _addState;
    unsigned int _schoolIdentity;
}

@property(nonatomic) unsigned int schoolIdentity; // @synthesize schoolIdentity=_schoolIdentity;
...
- (long long)compareMemberByFirstAlphabet:(id)arg1;
