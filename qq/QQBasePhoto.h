...
@property(copy, nonatomic) NSString *apngPath; // @synthesize apngPath=_apngPath;
@property(copy, nonatomic) NSString *bigFacePath; // @synthesize bigFacePath=_bigFacePath;
...
@property(retain, nonatomic) NSString *failedTips; // @dynamic failedTips;
