...
#import <QQMainProject/AsynFileStorageDelegate-Protocol.h>
#import <QQMainProject/IQQMessageProcessor-Protocol.h>
#import <QQMainProject/RegisterProxyTaskDelegate-Protocol.h>
...
- (id)requestMsgWithServerBuf:(id)arg1 andFlag:(unsigned int)arg2 taskRetrySeq:(unsigned long long)arg3 taskType:(unsigned int)arg4;
