...
#import <QQMainProject/MQZImagePickerDelegate-Protocol.h>
#import <QQMainProject/MQZMultiImagePickerWrapperDelegate-Protocol.h>
#import <QQMainProject/MQZoneActiveFeedHeaderViewDelegate-Protocol.h>
...
@interface MQZoneActiveFeedViewController : MQZCoverFeedListViewController <QQRichMediaPickerReportDelegate, MQZMultiImagePickerWrapperDelegate, QZMenuViewDelegate, MQZonePhotoDescriptionDelegate, QZCommonWidgetDelegate, QZAvatarWidgetDelegate, PhotoEditDelegate, QZEventWidgetDelegate, QZRooftopWebviewDelegate, UIActionSheetDelegate, MQZoneCoverHeaderViewDelegate, MQZoneActiveFeedHeaderViewDelegate, QZCoverViewWrapperDelegate, QQMultiImagePickerControllerDelegate, QZoneBannerContainerDelegate, QZIntelligenceBannerContainerDelegate, MQZImagePickerDelegate>
{
    ...
    _Bool _isRooftopAnimating;
    _Bool _hasRooftopExposed;
    QZRooftopInfo *_rooftopInfo;
    QZRooftopWebviewController *_rooftopWebviewController;
    QZRooftopNavigationController *_rooftopNaviController;
    double _rooftopPulldownThreshold;
    _Bool _forceReloadPassiveBanner;
    _Bool _isFromLocalFeed;
    NSMutableDictionary *_refreshTimeDic;
    NSMutableDictionary *_insertFeedDispatcher;
    NSMutableArray *_requestedRecommFeedList;
    long long _getRecommFeedRequestID;
    QzoneFeedModel *_feedWillBeRecom;
    long long _btnTypeUsedByRequestRecomFeed;
    ...
    _Bool _isFirstEnterQzone;
    _Bool _enterQzoneAndRefresh;
    _Bool _firstEnterQzoneAndRefresh;
    QZFloatView *_floatView;
    long long _getFeedRequestID;
    NSString *_currRefreshFirstFeedskey;
...
@property(nonatomic) _Bool isFirstEnterQzone; // @synthesize isFirstEnterQzone=_isFirstEnterQzone;
@property(nonatomic) double scrollBeginContentOffsetY; // @synthesize scrollBeginContentOffsetY=_scrollBeginContentOffsetY;
@property(retain, nonatomic) NSString *lastRefreshFirstFeedskey; // @synthesize lastRefreshFirstFeedskey=_lastRefreshFirstFeedskey;
@property(retain, nonatomic) NSString *currRefreshFirstFeedskey; // @synthesize currRefreshFirstFeedskey=_currRefreshFirstFeedskey;
...
- (int)onNotifyAfterForwardSuccess:(id)arg1;
- (void)refreshCell:(id)arg1 model:(id)arg2 isLike:(_Bool)arg3;
- (void)onBubbleSkinReady:(id)arg1;
...
- (void)reloadData;
- (void)reloadDataNeedLayout:(_Bool)arg1;
- (void)becomeActive;
- (void)onLeftButtonClicked;
- (void)showRooftop:(id)arg1;
- (void)processRooftopAnimation:(id)arg1;
- (_Bool)isRooftopAnimating:(id)arg1;
- (void)updateCommonWidgetAlpha:(double)arg1;
- (void)checkShowOrHidePet:(_Bool)arg1;
...
- (void)reportRefreshFeedTimes;
- (void)preloadFeedData:(id)arg1;
...
- (id)getFeedList;
- (void)onWillTriggerRecommFeed:(id)arg1;
- (void)onInsertFeed:(id)arg1;
- (void)registerInsertHander;
